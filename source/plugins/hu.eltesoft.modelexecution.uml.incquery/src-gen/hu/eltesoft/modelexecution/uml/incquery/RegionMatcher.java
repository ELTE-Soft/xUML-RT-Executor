...
/**
 * Generated pattern matcher API of the hu.eltesoft.modelexecution.uml.incquery.Region pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link RegionMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see RegionMatch
 * @see RegionProcessor
 * @see RegionQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class RegionMatcher extends BaseMatcher<RegionMatch> {
  /**
   * @return the singleton instance of the query specification of this pattern
   * @throws IncQueryException if the pattern definition could not be loaded
   * 
   */
  public static IQuerySpecification<RegionMatcher> querySpecification() throws IncQueryException {
   ...
   * 
   */
  public static RegionMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    RegionMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new RegionMatcher(engine);
   ...
   */
  @Deprecated
  public RegionMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public RegionMatcher(final IncQueryEngine engine) throws IncQueryException {
