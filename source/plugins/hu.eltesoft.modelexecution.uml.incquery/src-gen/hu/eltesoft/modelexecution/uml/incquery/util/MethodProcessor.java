...
public abstract class MethodProcessor implements IMatchProcessor<MethodMatch> {
   ...
   * 
   */
  public abstract void process(final org.eclipse.uml2.uml.Class pCls, final Operation pOperation, final String pMethodName);
  
  @Override
  public void process(final MethodMatch match) {
    process(match.getCls(), match.getOperation(), match.getMethodName());
