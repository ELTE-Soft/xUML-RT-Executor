...
public final class ContainerClassOfRegionQuerySpecification extends BaseGeneratedQuerySpecification<ContainerClassOfRegionMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("region","containerClassName");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("region", "org.eclipse.uml2.uml.Region"),new PParameter("containerClassName", "java.lang.String"));
  }
  ...
  public ContainerClassOfRegionMatch newMatch(final Object... parameters) {
    return ContainerClassOfRegionMatch.newMatch((org.eclipse.uml2.uml.Region) parameters[0], (java.lang.String) parameters[1]);
  }
