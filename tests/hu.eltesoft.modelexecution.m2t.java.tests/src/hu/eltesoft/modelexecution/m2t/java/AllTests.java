...
@SuiteClasses({ StepPartitioningTests.class, TemplateSmokeTests.class, AssignmentTests.class, AssociationTests.class,
		AttributeTests.class, DeclarationTests.class, ExtentTests.class, ExternalEntityTests.class,
		InvocationTests.class, LifecycleTests.class, LiteralTests.class, OperatorTests.class,
