 ...
 * <ul>
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.signal.impl.SgSignalImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SgSignalImpl extends NamedImpl implements SgSignal {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalPackage.SG_SIGNAL__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SignalPackage.SG_SIGNAL__ID:
				return getId();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Identified.class) {
			switch (derivedFeatureID) {
				case SignalPackage.SG_SIGNAL__ID: return BasePackage.IDENTIFIED__ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Identified.class) {
			switch (baseFeatureID) {
				case BasePackage.IDENTIFIED__ID: return SignalPackage.SG_SIGNAL__ID;
				default: return -1;
			}
		}
