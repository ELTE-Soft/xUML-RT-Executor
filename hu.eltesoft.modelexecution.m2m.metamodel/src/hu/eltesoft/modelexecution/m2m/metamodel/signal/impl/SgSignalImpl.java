 ...
 * <ul>
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.signal.impl.SgSignalImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SgSignalImpl extends MinimalEObjectImpl.Container implements SgSignal {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SignalPackage.SG_SIGNAL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SignalPackage.SG_SIGNAL__NAME:
				return getName();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Named.class) {
			switch (derivedFeatureID) {
				case SignalPackage.SG_SIGNAL__NAME: return BasePackage.NAMED__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Named.class) {
			switch (baseFeatureID) {
				case BasePackage.NAMED__NAME: return SignalPackage.SG_SIGNAL__NAME;
				default: return -1;
			}
		}
