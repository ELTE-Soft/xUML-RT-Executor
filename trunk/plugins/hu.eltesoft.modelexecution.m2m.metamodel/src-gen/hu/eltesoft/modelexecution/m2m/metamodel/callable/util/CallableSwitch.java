...
public class CallableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CallablePackage.CA_CALLABLE: {
				CaCallable caCallable = (CaCallable)theEObject;
				T result = caseCaCallable(caCallable);
				if (result == null) result = caseModelRoot(caCallable);
				if (result == null) result = caseNamed(caCallable);
				if (result == null) result = caseTranslationObject(caCallable);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ca Callable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ca Callable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCaCallable(CaCallable object) {
		return null;
	}
