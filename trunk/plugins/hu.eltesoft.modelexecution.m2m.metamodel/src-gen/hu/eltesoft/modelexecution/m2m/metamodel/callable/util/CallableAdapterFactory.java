 ...
 * @generated
 */
public class CallableAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected CallableSwitch<Adapter> modelSwitch =
		new CallableSwitch<Adapter>() {
			@Override
			public Adapter caseCaCallable(CaCallable object) {
				return createCaCallableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.eltesoft.modelexecution.m2m.metamodel.callable.CaCallable <em>Ca Callable</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCaCallableAdapter() {
		return null;
	}
