...
public class Registry {
	...
	static void registerReducedAlfLanguage() {
		...
		pkgRegistry.putIfAbsent(org.eclipse.xtext.XtextPackage.eNS_URI, org.eclipse.xtext.XtextPackage.eINSTANCE);
	...
	static void registerPathMaps(String jarPath) {
	...
	static void registerPathMaps() {
		try {
			String jarPath = Utils.getJarPath();
			registerPathMaps(jarPath);
