...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.OperationNotPublic pattern,
 * to be used in conjunction with {@link OperationNotPublicMatcher}.
 * 
...
public abstract class OperationNotPublicMatch extends BasePatternMatch {
  private Operation fOp;
  
  private static List<String> parameterNames = makeImmutableList("op");
  
  private OperationNotPublicMatch(final Operation pOp) {
    this.fOp = pOp;
  }
  ...
  public List<String> parameterNames() {
    return OperationNotPublicMatch.parameterNames;
  }
  ...
  @Override
  public OperationNotPublicMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof OperationNotPublicMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    OperationNotPublicMatch other = (OperationNotPublicMatch) obj;
  ...
  @Override
  public OperationNotPublicQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static OperationNotPublicMatch newEmptyMatch() {
   ...
   * 
   */
  public static OperationNotPublicMatch newMutableMatch(final Operation pOp) {
   ...
   * 
   */
  public static OperationNotPublicMatch newMatch(final Operation pOp) {
    return new Immutable(pOp);
  }
  
  private static final class Mutable extends OperationNotPublicMatch {
  ...
  private static final class Immutable extends OperationNotPublicMatch {
