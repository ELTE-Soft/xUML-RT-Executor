...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterNonPublic pattern,
 * to be used in conjunction with {@link ParameterNonPublicMatcher}.
 * 
...
public abstract class ParameterNonPublicMatch extends BasePatternMatch {
  private Parameter fPm;
  
  private static List<String> parameterNames = makeImmutableList("pm");
  
  private ParameterNonPublicMatch(final Parameter pPm) {
    this.fPm = pPm;
  }
  ...
  public List<String> parameterNames() {
    return ParameterNonPublicMatch.parameterNames;
  }
  ...
  @Override
  public ParameterNonPublicMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterNonPublicMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterNonPublicMatch other = (ParameterNonPublicMatch) obj;
  ...
  @Override
  public ParameterNonPublicQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterNonPublicMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterNonPublicMatch newMutableMatch(final Parameter pPm) {
   ...
   * 
   */
  public static ParameterNonPublicMatch newMatch(final Parameter pPm) {
    return new Immutable(pPm);
  }
  
  private static final class Mutable extends ParameterNonPublicMatch {
  ...
  private static final class Immutable extends ParameterNonPublicMatch {
