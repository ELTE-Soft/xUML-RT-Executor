...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.MethodActive pattern,
 * to be used in conjunction with {@link MethodActiveMatcher}.
 * 
...
public abstract class MethodActiveMatch extends BasePatternMatch {
  private OpaqueBehavior fMe;
  
  private static List<String> parameterNames = makeImmutableList("me");
  
  private MethodActiveMatch(final OpaqueBehavior pMe) {
    this.fMe = pMe;
  }
  ...
  public List<String> parameterNames() {
    return MethodActiveMatch.parameterNames;
  }
  ...
  @Override
  public MethodActiveMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MethodActiveMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MethodActiveMatch other = (MethodActiveMatch) obj;
  ...
  @Override
  public MethodActiveQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MethodActiveMatch newEmptyMatch() {
   ...
   * 
   */
  public static MethodActiveMatch newMutableMatch(final OpaqueBehavior pMe) {
   ...
   * 
   */
  public static MethodActiveMatch newMatch(final OpaqueBehavior pMe) {
    return new Immutable(pMe);
  }
  
  private static final class Mutable extends MethodActiveMatch {
  ...
  private static final class Immutable extends MethodActiveMatch {
