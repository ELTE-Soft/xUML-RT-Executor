...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.MethodElement pattern,
 * to be used in conjunction with {@link MethodElementMatcher}.
 * 
...
public abstract class MethodElementMatch extends BasePatternMatch {
  private Element fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private MethodElementMatch(final Element pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return MethodElementMatch.parameterNames;
  }
  ...
  @Override
  public MethodElementMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MethodElementMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MethodElementMatch other = (MethodElementMatch) obj;
  ...
  @Override
  public MethodElementQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static MethodElementMatch newEmptyMatch() {
   ...
   * 
   */
  public static MethodElementMatch newMutableMatch(final Element pElem) {
   ...
   * 
   */
  public static MethodElementMatch newMatch(final Element pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends MethodElementMatch {
  ...
  private static final class Immutable extends MethodElementMatch {
