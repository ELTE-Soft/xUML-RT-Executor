...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.RedefinedStatic pattern,
 * to be used in conjunction with {@link RedefinedStaticMatcher}.
 * 
...
public abstract class RedefinedStaticMatch extends BasePatternMatch {
  ...
  private RedefinedStaticMatch(final Operation pOp, final Operation pRedefined) {
    this.fOp = pOp;
  ...
  public List<String> parameterNames() {
    return RedefinedStaticMatch.parameterNames;
  }
  ...
  @Override
  public RedefinedStaticMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RedefinedStaticMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RedefinedStaticMatch other = (RedefinedStaticMatch) obj;
  ...
  @Override
  public RedefinedStaticQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RedefinedStaticMatch newEmptyMatch() {
   ...
   * 
   */
  public static RedefinedStaticMatch newMutableMatch(final Operation pOp, final Operation pRedefined) {
   ...
   * 
   */
  public static RedefinedStaticMatch newMatch(final Operation pOp, final Operation pRedefined) {
    return new Immutable(pOp, pRedefined);
  }
  
  private static final class Mutable extends RedefinedStaticMatch {
  ...
  private static final class Immutable extends RedefinedStaticMatch {
