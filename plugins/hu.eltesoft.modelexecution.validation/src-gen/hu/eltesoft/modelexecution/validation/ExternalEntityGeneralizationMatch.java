...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ExternalEntityGeneralization pattern,
 * to be used in conjunction with {@link ExternalEntityGeneralizationMatcher}.
 * 
...
public abstract class ExternalEntityGeneralizationMatch extends BasePatternMatch {
  ...
  private ExternalEntityGeneralizationMatch(final org.eclipse.uml2.uml.Class pCl) {
    this.fCl = pCl;
  }
  ...
  public List<String> parameterNames() {
    return ExternalEntityGeneralizationMatch.parameterNames;
  }
  ...
  @Override
  public ExternalEntityGeneralizationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ExternalEntityGeneralizationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ExternalEntityGeneralizationMatch other = (ExternalEntityGeneralizationMatch) obj;
  ...
  @Override
  public ExternalEntityGeneralizationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ExternalEntityGeneralizationMatch newMutableMatch(final org.eclipse.uml2.uml.Class pCl) {
   ...
   * 
   */
  public static ExternalEntityGeneralizationMatch newMatch(final org.eclipse.uml2.uml.Class pCl) {
    return new Immutable(pCl);
  }
  
  private static final class Mutable extends ExternalEntityGeneralizationMatch {
  ...
  private static final class Immutable extends ExternalEntityGeneralizationMatch {
