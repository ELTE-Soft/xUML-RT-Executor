...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterWithoutType pattern,
 * to be used in conjunction with {@link ParameterWithoutTypeMatcher}.
 * 
...
public abstract class ParameterWithoutTypeMatch extends BasePatternMatch {
  private Parameter fPm;
  
  private static List<String> parameterNames = makeImmutableList("pm");
  
  private ParameterWithoutTypeMatch(final Parameter pPm) {
    this.fPm = pPm;
  }
  ...
  public List<String> parameterNames() {
    return ParameterWithoutTypeMatch.parameterNames;
  }
  ...
  @Override
  public ParameterWithoutTypeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterWithoutTypeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterWithoutTypeMatch other = (ParameterWithoutTypeMatch) obj;
  ...
  @Override
  public ParameterWithoutTypeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterWithoutTypeMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterWithoutTypeMatch newMutableMatch(final Parameter pPm) {
   ...
   * 
   */
  public static ParameterWithoutTypeMatch newMatch(final Parameter pPm) {
    return new Immutable(pPm);
  }
  
  private static final class Mutable extends ParameterWithoutTypeMatch {
  ...
  private static final class Immutable extends ParameterWithoutTypeMatch {
