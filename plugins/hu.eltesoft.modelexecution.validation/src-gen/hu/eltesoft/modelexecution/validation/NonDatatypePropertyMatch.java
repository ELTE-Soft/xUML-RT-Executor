...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.NonDatatypeProperty pattern,
 * to be used in conjunction with {@link NonDatatypePropertyMatcher}.
 * 
...
public abstract class NonDatatypePropertyMatch extends BasePatternMatch {
  ...
  private NonDatatypePropertyMatch(final Property pPr) {
    this.fPr = pPr;
  }
  ...
  public List<String> parameterNames() {
    return NonDatatypePropertyMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NonDatatypePropertyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NonDatatypePropertyMatch other = (NonDatatypePropertyMatch) obj;
   ...
   * 
   */
  public static NonDatatypePropertyMatch newMutableMatch(final Property pPr) {
   ...
   * 
   */
  public static NonDatatypePropertyMatch newMatch(final Property pPr) {
    return new Immutable(pPr);
  }
  
  private static final class Mutable extends NonDatatypePropertyMatch {
  ...
  private static final class Immutable extends NonDatatypePropertyMatch {
