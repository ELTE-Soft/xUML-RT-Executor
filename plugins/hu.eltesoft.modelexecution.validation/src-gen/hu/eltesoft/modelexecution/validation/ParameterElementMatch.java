...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterElement pattern,
 * to be used in conjunction with {@link ParameterElementMatcher}.
 * 
...
public abstract class ParameterElementMatch extends BasePatternMatch {
  private Element fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private ParameterElementMatch(final Element pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return ParameterElementMatch.parameterNames;
  }
  ...
  @Override
  public ParameterElementMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterElementMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterElementMatch other = (ParameterElementMatch) obj;
  ...
  @Override
  public ParameterElementQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterElementMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterElementMatch newMutableMatch(final Element pElem) {
   ...
   * 
   */
  public static ParameterElementMatch newMatch(final Element pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends ParameterElementMatch {
  ...
  private static final class Immutable extends ParameterElementMatch {
