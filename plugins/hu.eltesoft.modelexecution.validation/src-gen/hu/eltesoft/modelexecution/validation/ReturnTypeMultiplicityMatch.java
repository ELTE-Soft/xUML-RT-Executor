...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ReturnTypeMultiplicity pattern,
 * to be used in conjunction with {@link ReturnTypeMultiplicityMatcher}.
 * 
...
public abstract class ReturnTypeMultiplicityMatch extends BasePatternMatch {
  private Parameter fParam;
  
  private static List<String> parameterNames = makeImmutableList("param");
  
  private ReturnTypeMultiplicityMatch(final Parameter pParam) {
    this.fParam = pParam;
  }
  ...
  public List<String> parameterNames() {
    return ReturnTypeMultiplicityMatch.parameterNames;
  }
  ...
  @Override
  public ReturnTypeMultiplicityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ReturnTypeMultiplicityMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ReturnTypeMultiplicityMatch other = (ReturnTypeMultiplicityMatch) obj;
  ...
  @Override
  public ReturnTypeMultiplicityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ReturnTypeMultiplicityMatch newEmptyMatch() {
   ...
   * 
   */
  public static ReturnTypeMultiplicityMatch newMutableMatch(final Parameter pParam) {
   ...
   * 
   */
  public static ReturnTypeMultiplicityMatch newMatch(final Parameter pParam) {
    return new Immutable(pParam);
  }
  
  private static final class Mutable extends ReturnTypeMultiplicityMatch {
  ...
  private static final class Immutable extends ReturnTypeMultiplicityMatch {
