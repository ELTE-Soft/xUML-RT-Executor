...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.PropertyIsReadOnly pattern,
 * to be used in conjunction with {@link PropertyIsReadOnlyMatcher}.
 * 
...
public abstract class PropertyIsReadOnlyMatch extends BasePatternMatch {
  private Property fPr;
  
  private static List<String> parameterNames = makeImmutableList("pr");
  
  private PropertyIsReadOnlyMatch(final Property pPr) {
    this.fPr = pPr;
  }
  ...
  public List<String> parameterNames() {
    return PropertyIsReadOnlyMatch.parameterNames;
  }
  ...
  @Override
  public PropertyIsReadOnlyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PropertyIsReadOnlyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PropertyIsReadOnlyMatch other = (PropertyIsReadOnlyMatch) obj;
  ...
  @Override
  public PropertyIsReadOnlyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PropertyIsReadOnlyMatch newEmptyMatch() {
   ...
   * 
   */
  public static PropertyIsReadOnlyMatch newMutableMatch(final Property pPr) {
   ...
   * 
   */
  public static PropertyIsReadOnlyMatch newMatch(final Property pPr) {
    return new Immutable(pPr);
  }
  
  private static final class Mutable extends PropertyIsReadOnlyMatch {
  ...
  private static final class Immutable extends PropertyIsReadOnlyMatch {
