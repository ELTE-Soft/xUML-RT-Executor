...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.PropertyIsID pattern,
 * to be used in conjunction with {@link PropertyIsIDMatcher}.
 * 
...
public abstract class PropertyIsIDMatch extends BasePatternMatch {
  private Property fPr;
  
  private static List<String> parameterNames = makeImmutableList("pr");
  
  private PropertyIsIDMatch(final Property pPr) {
    this.fPr = pPr;
  }
  ...
  public List<String> parameterNames() {
    return PropertyIsIDMatch.parameterNames;
  }
  ...
  @Override
  public PropertyIsIDMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PropertyIsIDMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PropertyIsIDMatch other = (PropertyIsIDMatch) obj;
  ...
  @Override
  public PropertyIsIDQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PropertyIsIDMatch newEmptyMatch() {
   ...
   * 
   */
  public static PropertyIsIDMatch newMutableMatch(final Property pPr) {
   ...
   * 
   */
  public static PropertyIsIDMatch newMatch(final Property pPr) {
    return new Immutable(pPr);
  }
  
  private static final class Mutable extends PropertyIsIDMatch {
  ...
  private static final class Immutable extends PropertyIsIDMatch {
