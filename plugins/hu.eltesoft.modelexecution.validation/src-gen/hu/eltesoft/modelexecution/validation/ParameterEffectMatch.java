...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterEffect pattern,
 * to be used in conjunction with {@link ParameterEffectMatcher}.
 * 
...
public abstract class ParameterEffectMatch extends BasePatternMatch {
  private Parameter fPm;
  
  private static List<String> parameterNames = makeImmutableList("pm");
  
  private ParameterEffectMatch(final Parameter pPm) {
    this.fPm = pPm;
  }
  ...
  public List<String> parameterNames() {
    return ParameterEffectMatch.parameterNames;
  }
  ...
  @Override
  public ParameterEffectMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterEffectMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterEffectMatch other = (ParameterEffectMatch) obj;
  ...
  @Override
  public ParameterEffectQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterEffectMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterEffectMatch newMutableMatch(final Parameter pPm) {
   ...
   * 
   */
  public static ParameterEffectMatch newMatch(final Parameter pPm) {
    return new Immutable(pPm);
  }
  
  private static final class Mutable extends ParameterEffectMatch {
  ...
  private static final class Immutable extends ParameterEffectMatch {
