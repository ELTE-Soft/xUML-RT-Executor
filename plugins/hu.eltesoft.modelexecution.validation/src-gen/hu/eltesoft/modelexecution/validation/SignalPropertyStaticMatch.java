...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.SignalPropertyStatic pattern,
 * to be used in conjunction with {@link SignalPropertyStaticMatcher}.
 * 
...
public abstract class SignalPropertyStaticMatch extends BasePatternMatch {
  private Signal fSg;
  ...
  private SignalPropertyStaticMatch(final Signal pSg, final Property pProp) {
    this.fSg = pSg;
    this.fProp = pProp;
  }
  ...
  public List<String> parameterNames() {
    return SignalPropertyStaticMatch.parameterNames;
  }
  ...
  @Override
  public SignalPropertyStaticMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SignalPropertyStaticMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SignalPropertyStaticMatch other = (SignalPropertyStaticMatch) obj;
  ...
  @Override
  public SignalPropertyStaticQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SignalPropertyStaticMatch newEmptyMatch() {
   ...
   * 
   */
  public static SignalPropertyStaticMatch newMutableMatch(final Signal pSg, final Property pProp) {
   ...
   * 
   */
  public static SignalPropertyStaticMatch newMatch(final Signal pSg, final Property pProp) {
    return new Immutable(pSg, pProp);
  }
  
  private static final class Mutable extends SignalPropertyStaticMatch {
  ...
  private static final class Immutable extends SignalPropertyStaticMatch {
