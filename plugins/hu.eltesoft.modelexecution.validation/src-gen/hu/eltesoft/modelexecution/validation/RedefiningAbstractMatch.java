...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.RedefiningAbstract pattern,
 * to be used in conjunction with {@link RedefiningAbstractMatcher}.
 * 
...
public abstract class RedefiningAbstractMatch extends BasePatternMatch {
  private Operation fOp;
  
  private static List<String> parameterNames = makeImmutableList("op");
  
  private RedefiningAbstractMatch(final Operation pOp) {
    this.fOp = pOp;
  }
  ...
  public List<String> parameterNames() {
    return RedefiningAbstractMatch.parameterNames;
  }
  ...
  @Override
  public RedefiningAbstractMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RedefiningAbstractMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RedefiningAbstractMatch other = (RedefiningAbstractMatch) obj;
  ...
  @Override
  public RedefiningAbstractQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RedefiningAbstractMatch newEmptyMatch() {
   ...
   * 
   */
  public static RedefiningAbstractMatch newMutableMatch(final Operation pOp) {
   ...
   * 
   */
  public static RedefiningAbstractMatch newMatch(final Operation pOp) {
    return new Immutable(pOp);
  }
  
  private static final class Mutable extends RedefiningAbstractMatch {
  ...
  private static final class Immutable extends RedefiningAbstractMatch {
