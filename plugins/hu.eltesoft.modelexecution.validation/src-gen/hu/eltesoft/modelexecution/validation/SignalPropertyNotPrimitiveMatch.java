...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.SignalPropertyNotPrimitive pattern,
 * to be used in conjunction with {@link SignalPropertyNotPrimitiveMatcher}.
 * 
...
public abstract class SignalPropertyNotPrimitiveMatch extends BasePatternMatch {
  ...
  private SignalPropertyNotPrimitiveMatch(final Signal pSg, final Property pProp) {
    this.fSg = pSg;
    this.fProp = pProp;
  }
  ...
  public List<String> parameterNames() {
    return SignalPropertyNotPrimitiveMatch.parameterNames;
  }
  ...
  @Override
  public SignalPropertyNotPrimitiveMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SignalPropertyNotPrimitiveMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SignalPropertyNotPrimitiveMatch other = (SignalPropertyNotPrimitiveMatch) obj;
  ...
  @Override
  public SignalPropertyNotPrimitiveQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SignalPropertyNotPrimitiveMatch newMutableMatch(final Signal pSg, final Property pProp) {
   ...
   * 
   */
  public static SignalPropertyNotPrimitiveMatch newMatch(final Signal pSg, final Property pProp) {
    return new Immutable(pSg, pProp);
  }
  
  private static final class Mutable extends SignalPropertyNotPrimitiveMatch {
  ...
  private static final class Immutable extends SignalPropertyNotPrimitiveMatch {
