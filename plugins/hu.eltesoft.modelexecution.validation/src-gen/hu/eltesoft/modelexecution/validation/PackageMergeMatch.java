...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.PackageMerge pattern,
 * to be used in conjunction with {@link PackageMergeMatcher}.
 * 
...
public abstract class PackageMergeMatch extends BasePatternMatch {
  private org.eclipse.uml2.uml.Package fPk;
  
  private static List<String> parameterNames = makeImmutableList("pk");
  
  private PackageMergeMatch(final org.eclipse.uml2.uml.Package pPk) {
    this.fPk = pPk;
  }
  ...
  public List<String> parameterNames() {
    return PackageMergeMatch.parameterNames;
  }
  ...
  @Override
  public PackageMergeMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PackageMergeMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PackageMergeMatch other = (PackageMergeMatch) obj;
  ...
  @Override
  public PackageMergeQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PackageMergeMatch newEmptyMatch() {
   ...
   * 
   */
  public static PackageMergeMatch newMutableMatch(final org.eclipse.uml2.uml.Package pPk) {
   ...
   * 
   */
  public static PackageMergeMatch newMatch(final org.eclipse.uml2.uml.Package pPk) {
    return new Immutable(pPk);
  }
  
  private static final class Mutable extends PackageMergeMatch {
  ...
  private static final class Immutable extends PackageMergeMatch {
