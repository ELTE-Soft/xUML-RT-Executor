...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.GeneralizationSet pattern,
 * to be used in conjunction with {@link GeneralizationSetMatcher}.
 * 
...
public abstract class GeneralizationSetMatch extends BasePatternMatch {
  ...
  private GeneralizationSetMatch(final Generalization pGen) {
    this.fGen = pGen;
  }
  ...
  public List<String> parameterNames() {
    return GeneralizationSetMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof GeneralizationSetMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    GeneralizationSetMatch other = (GeneralizationSetMatch) obj;
   ...
   * 
   */
  public static GeneralizationSetMatch newMutableMatch(final Generalization pGen) {
   ...
   * 
   */
  public static GeneralizationSetMatch newMatch(final Generalization pGen) {
    return new Immutable(pGen);
  }
  
  private static final class Mutable extends GeneralizationSetMatch {
  ...
  private static final class Immutable extends GeneralizationSetMatch {
