...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.AssociationMissingEnd pattern,
 * to be used in conjunction with {@link AssociationMissingEndMatcher}.
 * 
...
public abstract class AssociationMissingEndMatch extends BasePatternMatch {
  private Association fAc;
  
  private static List<String> parameterNames = makeImmutableList("ac");
  
  private AssociationMissingEndMatch(final Association pAc) {
    this.fAc = pAc;
  }
  ...
  public List<String> parameterNames() {
    return AssociationMissingEndMatch.parameterNames;
  }
  ...
  @Override
  public AssociationMissingEndMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AssociationMissingEndMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    AssociationMissingEndMatch other = (AssociationMissingEndMatch) obj;
  ...
  @Override
  public AssociationMissingEndQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static AssociationMissingEndMatch newEmptyMatch() {
   ...
   * 
   */
  public static AssociationMissingEndMatch newMutableMatch(final Association pAc) {
   ...
   * 
   */
  public static AssociationMissingEndMatch newMatch(final Association pAc) {
    return new Immutable(pAc);
  }
  
  private static final class Mutable extends AssociationMissingEndMatch {
  ...
  private static final class Immutable extends AssociationMissingEndMatch {
