...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ReceptionMethod pattern,
 * to be used in conjunction with {@link ReceptionMethodMatcher}.
 * 
...
public abstract class ReceptionMethodMatch extends BasePatternMatch {
  private Reception fRc;
  
  private static List<String> parameterNames = makeImmutableList("rc");
  
  private ReceptionMethodMatch(final Reception pRc) {
    this.fRc = pRc;
  }
  ...
  public List<String> parameterNames() {
    return ReceptionMethodMatch.parameterNames;
  }
  ...
  @Override
  public ReceptionMethodMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ReceptionMethodMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ReceptionMethodMatch other = (ReceptionMethodMatch) obj;
  ...
  @Override
  public ReceptionMethodQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ReceptionMethodMatch newEmptyMatch() {
   ...
   * 
   */
  public static ReceptionMethodMatch newMutableMatch(final Reception pRc) {
   ...
   * 
   */
  public static ReceptionMethodMatch newMatch(final Reception pRc) {
    return new Immutable(pRc);
  }
  
  private static final class Mutable extends ReceptionMethodMatch {
  ...
  private static final class Immutable extends ReceptionMethodMatch {
