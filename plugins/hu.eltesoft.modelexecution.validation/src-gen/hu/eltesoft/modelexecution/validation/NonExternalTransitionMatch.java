...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.NonExternalTransition pattern,
 * to be used in conjunction with {@link NonExternalTransitionMatcher}.
 * 
...
public abstract class NonExternalTransitionMatch extends BasePatternMatch {
  ...
  private NonExternalTransitionMatch(final Transition pTr) {
    this.fTr = pTr;
  }
  ...
  public List<String> parameterNames() {
    return NonExternalTransitionMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof NonExternalTransitionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    NonExternalTransitionMatch other = (NonExternalTransitionMatch) obj;
   ...
   * 
   */
  public static NonExternalTransitionMatch newMutableMatch(final Transition pTr) {
   ...
   * 
   */
  public static NonExternalTransitionMatch newMatch(final Transition pTr) {
    return new Immutable(pTr);
  }
  
  private static final class Mutable extends NonExternalTransitionMatch {
  ...
  private static final class Immutable extends NonExternalTransitionMatch {
