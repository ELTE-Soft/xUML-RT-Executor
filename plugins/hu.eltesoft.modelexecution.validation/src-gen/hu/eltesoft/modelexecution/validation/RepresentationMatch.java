...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.Representation pattern,
 * to be used in conjunction with {@link RepresentationMatcher}.
 * 
...
public abstract class RepresentationMatch extends BasePatternMatch {
  private Classifier fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private RepresentationMatch(final Classifier pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return RepresentationMatch.parameterNames;
  }
  ...
  @Override
  public RepresentationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RepresentationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RepresentationMatch other = (RepresentationMatch) obj;
  ...
  @Override
  public RepresentationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RepresentationMatch newEmptyMatch() {
   ...
   * 
   */
  public static RepresentationMatch newMutableMatch(final Classifier pElem) {
   ...
   * 
   */
  public static RepresentationMatch newMatch(final Classifier pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends RepresentationMatch {
  ...
  private static final class Immutable extends RepresentationMatch {
