...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.PowertypeExtent pattern,
 * to be used in conjunction with {@link PowertypeExtentMatcher}.
 * 
...
public abstract class PowertypeExtentMatch extends BasePatternMatch {
  private Classifier fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private PowertypeExtentMatch(final Classifier pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return PowertypeExtentMatch.parameterNames;
  }
  ...
  @Override
  public PowertypeExtentMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PowertypeExtentMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PowertypeExtentMatch other = (PowertypeExtentMatch) obj;
  ...
  @Override
  public PowertypeExtentQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PowertypeExtentMatch newEmptyMatch() {
   ...
   * 
   */
  public static PowertypeExtentMatch newMutableMatch(final Classifier pElem) {
   ...
   * 
   */
  public static PowertypeExtentMatch newMatch(final Classifier pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends PowertypeExtentMatch {
  ...
  private static final class Immutable extends PowertypeExtentMatch {
