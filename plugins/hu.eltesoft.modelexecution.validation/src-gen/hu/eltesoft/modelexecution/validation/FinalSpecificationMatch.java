...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.FinalSpecification pattern,
 * to be used in conjunction with {@link FinalSpecificationMatcher}.
 * 
...
public abstract class FinalSpecificationMatch extends BasePatternMatch {
  private Classifier fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private FinalSpecificationMatch(final Classifier pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return FinalSpecificationMatch.parameterNames;
  }
  ...
  @Override
  public FinalSpecificationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FinalSpecificationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    FinalSpecificationMatch other = (FinalSpecificationMatch) obj;
  ...
  @Override
  public FinalSpecificationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static FinalSpecificationMatch newEmptyMatch() {
   ...
   * 
   */
  public static FinalSpecificationMatch newMutableMatch(final Classifier pElem) {
   ...
   * 
   */
  public static FinalSpecificationMatch newMatch(final Classifier pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends FinalSpecificationMatch {
  ...
  private static final class Immutable extends FinalSpecificationMatch {
