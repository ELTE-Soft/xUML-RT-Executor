...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.UseCase pattern,
 * to be used in conjunction with {@link UseCaseMatcher}.
 * 
...
public abstract class UseCaseMatch extends BasePatternMatch {
  private Classifier fElem;
  
  private static List<String> parameterNames = makeImmutableList("elem");
  
  private UseCaseMatch(final Classifier pElem) {
    this.fElem = pElem;
  }
  ...
  public List<String> parameterNames() {
    return UseCaseMatch.parameterNames;
  }
  ...
  @Override
  public UseCaseMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof UseCaseMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    UseCaseMatch other = (UseCaseMatch) obj;
  ...
  @Override
  public UseCaseQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static UseCaseMatch newEmptyMatch() {
   ...
   * 
   */
  public static UseCaseMatch newMutableMatch(final Classifier pElem) {
   ...
   * 
   */
  public static UseCaseMatch newMatch(final Classifier pElem) {
    return new Immutable(pElem);
  }
  
  private static final class Mutable extends UseCaseMatch {
  ...
  private static final class Immutable extends UseCaseMatch {
