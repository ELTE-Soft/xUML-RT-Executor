...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ReceptionAbstract pattern,
 * to be used in conjunction with {@link ReceptionAbstractMatcher}.
 * 
...
public abstract class ReceptionAbstractMatch extends BasePatternMatch {
  private Reception fRc;
  
  private static List<String> parameterNames = makeImmutableList("rc");
  
  private ReceptionAbstractMatch(final Reception pRc) {
    this.fRc = pRc;
  }
  ...
  public List<String> parameterNames() {
    return ReceptionAbstractMatch.parameterNames;
  }
  ...
  @Override
  public ReceptionAbstractMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ReceptionAbstractMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ReceptionAbstractMatch other = (ReceptionAbstractMatch) obj;
  ...
  @Override
  public ReceptionAbstractQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ReceptionAbstractMatch newEmptyMatch() {
   ...
   * 
   */
  public static ReceptionAbstractMatch newMutableMatch(final Reception pRc) {
   ...
   * 
   */
  public static ReceptionAbstractMatch newMatch(final Reception pRc) {
    return new Immutable(pRc);
  }
  
  private static final class Mutable extends ReceptionAbstractMatch {
  ...
  private static final class Immutable extends ReceptionAbstractMatch {
