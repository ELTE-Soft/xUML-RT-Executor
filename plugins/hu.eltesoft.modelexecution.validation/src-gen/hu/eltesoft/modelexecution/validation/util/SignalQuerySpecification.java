...
final class SignalQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  private SignalQuerySpecification() {
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static SignalQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.eltesoft.modelexecution.validation.Signal";
    }
