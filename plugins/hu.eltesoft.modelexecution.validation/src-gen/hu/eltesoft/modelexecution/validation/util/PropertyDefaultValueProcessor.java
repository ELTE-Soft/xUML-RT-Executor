...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.PropertyDefaultValue pattern.
 * 
...
public abstract class PropertyDefaultValueProcessor implements IMatchProcessor<PropertyDefaultValueMatch> {
  ...
  @Override
  public void process(final PropertyDefaultValueMatch match) {
    process(match.getPr());
  }
}
