...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.LowBoundInfinite pattern.
 * 
...
public abstract class LowBoundInfiniteProcessor implements IMatchProcessor<LowBoundInfiniteMatch> {
  ...
  @Override
  public void process(final LowBoundInfiniteMatch match) {
    process(match.getMe());
  }
}
