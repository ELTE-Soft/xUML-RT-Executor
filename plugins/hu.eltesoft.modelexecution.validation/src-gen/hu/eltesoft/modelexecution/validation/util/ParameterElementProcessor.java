...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.ParameterElement pattern.
 * 
...
public abstract class ParameterElementProcessor implements IMatchProcessor<ParameterElementMatch> {
  ...
  @Override
  public void process(final ParameterElementMatch match) {
