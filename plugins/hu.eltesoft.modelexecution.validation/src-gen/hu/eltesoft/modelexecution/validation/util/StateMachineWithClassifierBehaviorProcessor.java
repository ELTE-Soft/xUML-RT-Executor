...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.StateMachineWithClassifierBehavior pattern.
 * 
...
public abstract class StateMachineWithClassifierBehaviorProcessor implements IMatchProcessor<StateMachineWithClassifierBehaviorMatch> {
  ...
  @Override
  public void process(final StateMachineWithClassifierBehaviorMatch match) {
    process(match.getSm());
  }
}
