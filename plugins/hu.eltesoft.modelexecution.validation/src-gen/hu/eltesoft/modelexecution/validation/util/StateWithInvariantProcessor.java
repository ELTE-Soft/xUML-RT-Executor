...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.StateWithInvariant pattern.
 * 
...
public abstract class StateWithInvariantProcessor implements IMatchProcessor<StateWithInvariantMatch> {
  ...
  @Override
  public void process(final StateWithInvariantMatch match) {
    process(match.getSt());
  }
}
