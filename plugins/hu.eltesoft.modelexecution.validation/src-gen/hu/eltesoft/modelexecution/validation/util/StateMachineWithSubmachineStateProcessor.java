...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.StateMachineWithSubmachineState pattern.
 * 
...
public abstract class StateMachineWithSubmachineStateProcessor implements IMatchProcessor<StateMachineWithSubmachineStateMatch> {
  ...
  @Override
  public void process(final StateMachineWithSubmachineStateMatch match) {
    process(match.getSm());
  }
}
