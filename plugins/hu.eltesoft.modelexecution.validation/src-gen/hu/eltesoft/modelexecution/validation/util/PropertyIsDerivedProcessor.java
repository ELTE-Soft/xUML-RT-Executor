...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.validation.PropertyIsDerived pattern.
 * 
...
public abstract class PropertyIsDerivedProcessor implements IMatchProcessor<PropertyIsDerivedMatch> {
  ...
  @Override
  public void process(final PropertyIsDerivedMatch match) {
    process(match.getPr());
  }
}
