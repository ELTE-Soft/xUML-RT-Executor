...
/**
 * A pattern-specific query specification that can instantiate InitialTransitionMatcher in a type-safe way.
 * 
 * @see InitialTransitionMatcher
 * @see InitialTransitionMatch
 * 
 */
@SuppressWarnings("all")
final class InitialTransitionQuerySpecification extends BaseGeneratedEMFQuerySpecification<IncQueryMatcher<IPatternMatch>> {
  private InitialTransitionQuerySpecification() {
   ...
   * 
   */
  public static InitialTransitionQuerySpecification instance() throws IncQueryException {
    try{
  ...
  private static class LazyHolder {
    private final static InitialTransitionQuerySpecification INSTANCE = make();
    
    public static InitialTransitionQuerySpecification make() {
      return new InitialTransitionQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static InitialTransitionQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "hu.eltesoft.modelexecution.validation.InitialTransition";
    }
    
    @Override
    public List<String> getParameterNames() {
      return Arrays.asList("src","tr");
    }
    
    @Override
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("src", "org.eclipse.uml2.uml.Pseudostate"),new PParameter("tr", "org.eclipse.uml2.uml.Transition"));
    }
