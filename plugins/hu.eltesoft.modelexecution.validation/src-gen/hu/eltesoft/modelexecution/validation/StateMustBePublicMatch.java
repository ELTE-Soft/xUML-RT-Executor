...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.StateMustBePublic pattern,
 * to be used in conjunction with {@link StateMustBePublicMatcher}.
 * 
...
public abstract class StateMustBePublicMatch extends BasePatternMatch {
  ...
  private StateMustBePublicMatch(final State pSt) {
    this.fSt = pSt;
  }
  ...
  public List<String> parameterNames() {
    return StateMustBePublicMatch.parameterNames;
  }
  ...
  @Override
  public StateMustBePublicMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof StateMustBePublicMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    StateMustBePublicMatch other = (StateMustBePublicMatch) obj;
  ...
  @Override
  public StateMustBePublicQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static StateMustBePublicMatch newMutableMatch(final State pSt) {
   ...
   * 
   */
  public static StateMustBePublicMatch newMatch(final State pSt) {
    return new Immutable(pSt);
  }
  
  private static final class Mutable extends StateMustBePublicMatch {
  ...
  private static final class Immutable extends StateMustBePublicMatch {
