...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterSet pattern,
 * to be used in conjunction with {@link ParameterSetMatcher}.
 * 
...
public abstract class ParameterSetMatch extends BasePatternMatch {
  private Parameter fPm;
  
  private static List<String> parameterNames = makeImmutableList("pm");
  
  private ParameterSetMatch(final Parameter pPm) {
    this.fPm = pPm;
  }
  ...
  public List<String> parameterNames() {
    return ParameterSetMatch.parameterNames;
  }
  ...
  @Override
  public ParameterSetMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterSetMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterSetMatch other = (ParameterSetMatch) obj;
  ...
  @Override
  public ParameterSetQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterSetMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterSetMatch newMutableMatch(final Parameter pPm) {
   ...
   * 
   */
  public static ParameterSetMatch newMatch(final Parameter pPm) {
    return new Immutable(pPm);
  }
  
  private static final class Mutable extends ParameterSetMatch {
  ...
  private static final class Immutable extends ParameterSetMatch {
