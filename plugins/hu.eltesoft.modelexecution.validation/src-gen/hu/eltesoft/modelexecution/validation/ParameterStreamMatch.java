...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.ParameterStream pattern,
 * to be used in conjunction with {@link ParameterStreamMatcher}.
 * 
...
public abstract class ParameterStreamMatch extends BasePatternMatch {
  private Parameter fPm;
  
  private static List<String> parameterNames = makeImmutableList("pm");
  
  private ParameterStreamMatch(final Parameter pPm) {
    this.fPm = pPm;
  }
  ...
  public List<String> parameterNames() {
    return ParameterStreamMatch.parameterNames;
  }
  ...
  @Override
  public ParameterStreamMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ParameterStreamMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ParameterStreamMatch other = (ParameterStreamMatch) obj;
  ...
  @Override
  public ParameterStreamQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ParameterStreamMatch newEmptyMatch() {
   ...
   * 
   */
  public static ParameterStreamMatch newMutableMatch(final Parameter pPm) {
   ...
   * 
   */
  public static ParameterStreamMatch newMatch(final Parameter pPm) {
    return new Immutable(pPm);
  }
  
  private static final class Mutable extends ParameterStreamMatch {
  ...
  private static final class Immutable extends ParameterStreamMatch {
