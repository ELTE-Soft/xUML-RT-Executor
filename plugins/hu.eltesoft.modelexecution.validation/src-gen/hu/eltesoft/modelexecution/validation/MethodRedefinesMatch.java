...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.MethodRedefines pattern,
 * to be used in conjunction with {@link MethodRedefinesMatcher}.
 * 
...
public abstract class MethodRedefinesMatch extends BasePatternMatch {
  ...
  private MethodRedefinesMatch(final OpaqueBehavior pMe) {
    this.fMe = pMe;
  }
  ...
  public List<String> parameterNames() {
    return MethodRedefinesMatch.parameterNames;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MethodRedefinesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    MethodRedefinesMatch other = (MethodRedefinesMatch) obj;
   ...
   * 
   */
  public static MethodRedefinesMatch newMutableMatch(final OpaqueBehavior pMe) {
   ...
   * 
   */
  public static MethodRedefinesMatch newMatch(final OpaqueBehavior pMe) {
    return new Immutable(pMe);
  }
  
  private static final class Mutable extends MethodRedefinesMatch {
  ...
  private static final class Immutable extends MethodRedefinesMatch {
