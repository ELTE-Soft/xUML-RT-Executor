...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.validation.CyclicInheritance pattern,
 * to be used in conjunction with {@link CyclicInheritanceMatcher}.
 * 
...
public abstract class CyclicInheritanceMatch extends BasePatternMatch {
  private org.eclipse.uml2.uml.Class fCl;
  
  private static List<String> parameterNames = makeImmutableList("cl");
  
  private CyclicInheritanceMatch(final org.eclipse.uml2.uml.Class pCl) {
    this.fCl = pCl;
  }
  ...
  public List<String> parameterNames() {
    return CyclicInheritanceMatch.parameterNames;
  }
  ...
  @Override
  public CyclicInheritanceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CyclicInheritanceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CyclicInheritanceMatch other = (CyclicInheritanceMatch) obj;
  ...
  @Override
  public CyclicInheritanceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CyclicInheritanceMatch newEmptyMatch() {
   ...
   * 
   */
  public static CyclicInheritanceMatch newMutableMatch(final org.eclipse.uml2.uml.Class pCl) {
   ...
   * 
   */
  public static CyclicInheritanceMatch newMatch(final org.eclipse.uml2.uml.Class pCl) {
    return new Immutable(pCl);
  }
  
  private static final class Mutable extends CyclicInheritanceMatch {
  ...
  private static final class Immutable extends CyclicInheritanceMatch {
