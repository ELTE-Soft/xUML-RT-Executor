 ...
 * <ul>
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.region.impl.RgClassImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RgClassImpl extends MinimalEObjectImpl.Container implements RgClass {
	...
	public void setReference(NamedReference newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RegionPackage.RG_CLASS__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RegionPackage.RG_CLASS__REFERENCE:
				return getReference();
		}
