 ...
 * <ul>
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.classdef.impl.ClSignalImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClSignalImpl extends MinimalEObjectImpl.Container implements ClSignal {
	...
	public void setReference(NamedReference newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdefPackage.CL_SIGNAL__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassdefPackage.CL_SIGNAL__REFERENCE:
				return getReference();
		}
