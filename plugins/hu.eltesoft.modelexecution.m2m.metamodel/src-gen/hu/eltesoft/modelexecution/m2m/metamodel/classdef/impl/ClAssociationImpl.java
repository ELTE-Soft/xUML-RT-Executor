 ...
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.classdef.impl.ClAssociationImpl#getMultiplicity <em>Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClAssociationImpl extends MinimalEObjectImpl.Container implements ClAssociation {
	...
	public void setMultiplicity(Multiplicity newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassdefPackage.CL_ASSOCIATION__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ClassdefPackage.CL_ASSOCIATION__TYPE:
				...
				return basicGetType();
			case ClassdefPackage.CL_ASSOCIATION__MULTIPLICITY:
