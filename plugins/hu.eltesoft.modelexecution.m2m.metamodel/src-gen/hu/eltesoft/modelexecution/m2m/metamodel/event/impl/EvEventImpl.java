...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ev Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link hu.eltesoft.modelexecution.m2m.metamodel.event.impl.EvEventImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EvEventImpl extends MinimalEObjectImpl.Container implements EvEvent {
	...
	protected EClass eStaticClass() {
		return EventPackage.Literals.EV_EVENT;
	}
	...
	public void setReference(NamedReference newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventPackage.EV_EVENT__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventPackage.EV_EVENT__REFERENCE:
				return getReference();
		}
