...
public interface EventPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int EV_EVENT_OPERATION_COUNT = BasePackage.MODEL_ROOT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the attribute '{@link hu.eltesoft.modelexecution.m2m.metamodel.event.EvSignalEvent#getSignal <em>Signal</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute EV_SIGNAL_EVENT__SIGNAL = eINSTANCE.getEvSignalEvent_Signal();
