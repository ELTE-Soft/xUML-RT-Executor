...
public abstract class AttributeProcessor implements IMatchProcessor<AttributeMatch> {
   ...
   * 
   */
  public abstract void process(final org.eclipse.uml2.uml.Class pCls, final Property pAttribute, final Boolean pIsStatic, final Type pType);
  
  @Override
  public void process(final AttributeMatch match) {
    process(match.getCls(), match.getAttribute(), match.getIsStatic(), match.getType());
