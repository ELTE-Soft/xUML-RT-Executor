...
public final class ClassAssociationTypeQuerySpecification extends BaseGeneratedQuerySpecification<ClassAssociationTypeMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("cls","end","type");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("cls", "org.eclipse.uml2.uml.Class"),new PParameter("end", "org.eclipse.uml2.uml.Property"),new PParameter("type", "org.eclipse.uml2.uml.Association"));
  }
  ...
  public ClassAssociationTypeMatch newMatch(final Object... parameters) {
    return ClassAssociationTypeMatch.newMatch((org.eclipse.uml2.uml.Class) parameters[0], (org.eclipse.uml2.uml.Property) parameters[1], (org.eclipse.uml2.uml.Association) parameters[2]);
  }
