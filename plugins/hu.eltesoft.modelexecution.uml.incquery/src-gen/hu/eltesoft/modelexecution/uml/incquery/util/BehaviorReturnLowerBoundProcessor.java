...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.uml.incquery.BehaviorReturnLowerBound pattern.
 * 
...
public abstract class BehaviorReturnLowerBoundProcessor implements IMatchProcessor<BehaviorReturnLowerBoundMatch> {
  ...
  @Override
  public void process(final BehaviorReturnLowerBoundMatch match) {
