...
/**
 * Generated pattern matcher API of the hu.eltesoft.modelexecution.uml.incquery.ReceptionParameterType pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link ReceptionParameterTypeMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 * pattern ReceptionParameterType(cls: Class, reception : Reception, parameter : Parameter, type : Type, ordered, unique) {
 ...
 * @see ReceptionParameterTypeQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class ReceptionParameterTypeMatcher extends BaseMatcher<ReceptionParameterTypeMatch> {
  /**
   * @return the singleton instance of the query specification of this pattern
   * @throws IncQueryException if the pattern definition could not be loaded
   * 
   */
  public static IQuerySpecification<ReceptionParameterTypeMatcher> querySpecification() throws IncQueryException {
   ...
   * 
   */
  public static ReceptionParameterTypeMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    ReceptionParameterTypeMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new ReceptionParameterTypeMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(ReceptionParameterTypeMatcher.class);
   ...
   */
  @Deprecated
  public ReceptionParameterTypeMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public ReceptionParameterTypeMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a ReceptionParameterTypeMatch object.
   * 
   */
  public Collection<ReceptionParameterTypeMatch> getAllMatches(final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique) {
   ...
   * @param pOrdered the fixed value of pattern parameter ordered, or null if not bound.
   * @param pUnique the fixed value of pattern parameter unique, or null if not bound.
   * @return a match represented as a ReceptionParameterTypeMatch object, or null if no match is found.
   * 
   */
  public ReceptionParameterTypeMatch getOneArbitraryMatch(final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique) {
   ...
   * 
   */
  public void forEachMatch(final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique, final IMatchProcessor<? super ReceptionParameterTypeMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique, final IMatchProcessor<? super ReceptionParameterTypeMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<ReceptionParameterTypeMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique) {
   ...
   * 
   */
  public ReceptionParameterTypeMatch newMatch(final org.eclipse.uml2.uml.Class pCls, final Reception pReception, final Parameter pParameter, final Type pType, final Boolean pOrdered, final Boolean pUnique) {
    return ReceptionParameterTypeMatch.newMatch(pCls, pReception, pParameter, pType, pOrdered, pUnique);
   ...
   * 
   */
  public Set<org.eclipse.uml2.uml.Class> getAllValuesOfcls(final ReceptionParameterTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Reception> getAllValuesOfreception(final ReceptionParameterTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Parameter> getAllValuesOfparameter(final ReceptionParameterTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Type> getAllValuesOftype(final ReceptionParameterTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Boolean> getAllValuesOfordered(final ReceptionParameterTypeMatch partialMatch) {
   ...
   * 
   */
  public Set<Boolean> getAllValuesOfunique(final ReceptionParameterTypeMatch partialMatch) {
  ...
  @Override
  protected ReceptionParameterTypeMatch tupleToMatch(final Tuple t) {
    try {
      return ReceptionParameterTypeMatch.newMatch((org.eclipse.uml2.uml.Class) t.get(POSITION_CLS), (org.eclipse.uml2.uml.Reception) t.get(POSITION_RECEPTION), (org.eclipse.uml2.uml.Parameter) t.get(POSITION_PARAMETER), (org.eclipse.uml2.uml.Type) t.get(POSITION_TYPE), (java.lang.Boolean) t.get(POSITION_ORDERED), (java.lang.Boolean) t.get(POSITION_UNIQUE));
  ...
  @Override
  protected ReceptionParameterTypeMatch arrayToMatch(final Object[] match) {
    try {
      return ReceptionParameterTypeMatch.newMatch((org.eclipse.uml2.uml.Class) match[POSITION_CLS], (org.eclipse.uml2.uml.Reception) match[POSITION_RECEPTION], (org.eclipse.uml2.uml.Parameter) match[POSITION_PARAMETER], (org.eclipse.uml2.uml.Type) match[POSITION_TYPE], (java.lang.Boolean) match[POSITION_ORDERED], (java.lang.Boolean) match[POSITION_UNIQUE]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected ReceptionParameterTypeMatch arrayToMatchMutable(final Object[] match) {
    try {
      return ReceptionParameterTypeMatch.newMutableMatch((org.eclipse.uml2.uml.Class) match[POSITION_CLS], (org.eclipse.uml2.uml.Reception) match[POSITION_RECEPTION], (org.eclipse.uml2.uml.Parameter) match[POSITION_PARAMETER], (org.eclipse.uml2.uml.Type) match[POSITION_TYPE], (java.lang.Boolean) match[POSITION_ORDERED], (java.lang.Boolean) match[POSITION_UNIQUE]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
