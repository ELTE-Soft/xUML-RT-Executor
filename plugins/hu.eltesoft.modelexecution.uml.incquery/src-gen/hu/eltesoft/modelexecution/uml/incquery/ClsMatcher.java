...
/**
 * Generated pattern matcher API of the hu.eltesoft.modelexecution.uml.incquery.Cls pattern,
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)},
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link ClsMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see ClsMatch
 * @see ClsProcessor
 * @see ClsQuerySpecification
 * 
 */
@SuppressWarnings("all")
public class ClsMatcher extends BaseMatcher<ClsMatch> {
  /**
   * @return the singleton instance of the query specification of this pattern
   * @throws IncQueryException if the pattern definition could not be loaded
   * 
   */
  public static IQuerySpecification<ClsMatcher> querySpecification() throws IncQueryException {
   ...
   * 
   */
  public static ClsMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    ClsMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new ClsMatcher(engine);
   ...
   */
  @Deprecated
  public ClsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public ClsMatcher(final IncQueryEngine engine) throws IncQueryException {
