...
public final class RegionOfClassQuerySpecification extends BaseGeneratedQuerySpecification<RegionOfClassMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("cls","region","regionName");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("cls", "org.eclipse.uml2.uml.Class"),new PParameter("region", "org.eclipse.uml2.uml.Region"),new PParameter("regionName", "java.lang.String"));
  }
  ...
  public RegionOfClassMatch newMatch(final Object... parameters) {
    return RegionOfClassMatch.newMatch((org.eclipse.uml2.uml.Class) parameters[0], (org.eclipse.uml2.uml.Region) parameters[1], (java.lang.String) parameters[2]);
  }
