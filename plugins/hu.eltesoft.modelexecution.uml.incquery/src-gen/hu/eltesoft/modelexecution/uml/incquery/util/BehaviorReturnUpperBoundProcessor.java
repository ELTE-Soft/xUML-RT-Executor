...
/**
 * A match processor tailored for the hu.eltesoft.modelexecution.uml.incquery.BehaviorReturnUpperBound pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class BehaviorReturnUpperBoundProcessor implements IMatchProcessor<BehaviorReturnUpperBoundMatch> {
  /**
  ...
  @Override
  public void process(final BehaviorReturnUpperBoundMatch match) {
