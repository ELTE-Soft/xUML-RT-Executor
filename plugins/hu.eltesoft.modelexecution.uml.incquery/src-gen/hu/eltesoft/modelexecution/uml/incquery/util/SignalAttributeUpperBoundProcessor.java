...
public abstract class SignalAttributeUpperBoundProcessor implements IMatchProcessor<SignalAttributeUpperBoundMatch> {
   ...
   * 
   */
  public abstract void process(final Signal pSignal, final Property pAttribute, final ValueSpecification pUpperBound);
  
  @Override
  public void process(final SignalAttributeUpperBoundMatch match) {
    process(match.getSignal(), match.getAttribute(), match.getUpperBound());
