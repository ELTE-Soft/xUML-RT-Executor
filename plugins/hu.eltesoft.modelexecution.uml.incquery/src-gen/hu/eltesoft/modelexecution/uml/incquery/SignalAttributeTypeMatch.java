...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.uml.incquery.SignalAttributeType pattern,
 * to be used in conjunction with {@link SignalAttributeTypeMatcher}.
 * 
...
public abstract class SignalAttributeTypeMatch extends BasePatternMatch {
  ...
  public List<String> parameterNames() {
    return SignalAttributeTypeMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SignalAttributeTypeMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    SignalAttributeTypeMatch other = (SignalAttributeTypeMatch) obj;
  ...
  @Override
  public SignalAttributeTypeQuerySpecification specification() {
    try {
