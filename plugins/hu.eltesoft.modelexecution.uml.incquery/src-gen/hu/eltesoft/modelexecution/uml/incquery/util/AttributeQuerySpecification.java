...
public final class AttributeQuerySpecification extends BaseGeneratedQuerySpecification<AttributeMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("cls","attribute","isStatic");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("cls", "org.eclipse.uml2.uml.Class"),new PParameter("attribute", "org.eclipse.uml2.uml.Property"),new PParameter("isStatic", "java.lang.Boolean"));
  }
  ...
  public AttributeMatch newMatch(final Object... parameters) {
    return AttributeMatch.newMatch((org.eclipse.uml2.uml.Class) parameters[0], (org.eclipse.uml2.uml.Property) parameters[1], (java.lang.Boolean) parameters[2]);
  }
