...
public final class ReceptionParameterLowerBoundQuerySpecification extends BaseGeneratedQuerySpecification<ReceptionParameterLowerBoundMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("cls","reception","parameter","lowerBound");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("cls", "org.eclipse.uml2.uml.Class"),new PParameter("reception", "org.eclipse.uml2.uml.Reception"),new PParameter("parameter", "org.eclipse.uml2.uml.Parameter"),new PParameter("lowerBound", "org.eclipse.uml2.uml.ValueSpecification"));
  }
  ...
  public ReceptionParameterLowerBoundMatch newMatch(final Object... parameters) {
    return ReceptionParameterLowerBoundMatch.newMatch((org.eclipse.uml2.uml.Class) parameters[0], (org.eclipse.uml2.uml.Reception) parameters[1], (org.eclipse.uml2.uml.Parameter) parameters[2], (org.eclipse.uml2.uml.ValueSpecification) parameters[3]);
  }
