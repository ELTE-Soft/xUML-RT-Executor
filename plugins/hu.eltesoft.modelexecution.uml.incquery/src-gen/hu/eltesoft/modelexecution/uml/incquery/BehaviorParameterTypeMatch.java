...
public abstract class BehaviorParameterTypeMatch extends BasePatternMatch {
  ...
  private BehaviorParameterTypeMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType) {
   ...
   * 
   */
  public static BehaviorParameterTypeMatch newMutableMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType) {
   ...
   * 
   */
  public static BehaviorParameterTypeMatch newMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType) {
