...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.uml.incquery.BehaviorReturnUpperBound pattern,
 * to be used in conjunction with {@link BehaviorReturnUpperBoundMatcher}.
 * 
...
public abstract class BehaviorReturnUpperBoundMatch extends BasePatternMatch {
  ...
  private BehaviorReturnUpperBoundMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pUpperBound) {
  ...
  public List<String> parameterNames() {
    return BehaviorReturnUpperBoundMatch.parameterNames;
  ...
  @Override
  public BehaviorReturnUpperBoundMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BehaviorReturnUpperBoundMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    BehaviorReturnUpperBoundMatch other = (BehaviorReturnUpperBoundMatch) obj;
  ...
  @Override
  public BehaviorReturnUpperBoundQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BehaviorReturnUpperBoundMatch newEmptyMatch() {
   ...
   * 
   */
  public static BehaviorReturnUpperBoundMatch newMutableMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pUpperBound) {
   ...
   * 
   */
  public static BehaviorReturnUpperBoundMatch newMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pUpperBound) {
    return new Immutable(pBehavior, pParameter, pType, pUpperBound);
    
  }
  
  private static final class Mutable extends BehaviorReturnUpperBoundMatch {
  ...
  private static final class Immutable extends BehaviorReturnUpperBoundMatch {
