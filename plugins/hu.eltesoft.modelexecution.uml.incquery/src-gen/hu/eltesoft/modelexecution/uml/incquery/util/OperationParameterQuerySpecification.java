...
public final class OperationParameterQuerySpecification extends BaseGeneratedQuerySpecification<OperationParameterMatcher> {
  ...
  public List<String> getParameterNames() {
    return Arrays.asList("cls","operation","parameter","direction");
  }
  
  @Override
  public List<PParameter> getParameters() {
    return Arrays.asList(new PParameter("cls", "org.eclipse.uml2.uml.Class"),new PParameter("operation", "org.eclipse.uml2.uml.Operation"),new PParameter("parameter", "org.eclipse.uml2.uml.Parameter"),new PParameter("direction", "org.eclipse.uml2.uml.ParameterDirectionKind"));
  }
  ...
  public OperationParameterMatch newMatch(final Object... parameters) {
    return OperationParameterMatch.newMatch((org.eclipse.uml2.uml.Class) parameters[0], (org.eclipse.uml2.uml.Operation) parameters[1], (org.eclipse.uml2.uml.Parameter) parameters[2], (org.eclipse.uml2.uml.ParameterDirectionKind) parameters[3]);
  }
