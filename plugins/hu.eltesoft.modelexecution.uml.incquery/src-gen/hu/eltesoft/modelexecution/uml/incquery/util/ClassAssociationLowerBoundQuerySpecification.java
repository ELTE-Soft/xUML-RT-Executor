...
public final class ClassAssociationLowerBoundQuerySpecification extends BaseGeneratedQuerySpecification<ClassAssociationLowerBoundMatcher> {
  ...
  public Set<PBody> doGetContainedBodies() throws IncQueryException {
    Set<PBody> bodies = Sets.newLinkedHashSet();
    {
      ...
      new TypeUnary(body, var_lowerBound, getClassifierLiteral("http://www.eclipse.org/uml2/5.0.0/UML", "ValueSpecification"), "http://www.eclipse.org/uml2/5.0.0/UML/ValueSpecification");
      new PositivePatternCall(body, new FlatTuple(var_type, var_end, var_cls, var_lowerBound), AssociationEndLowerBoundQuerySpecification.instance());
      bodies.add(body);
    }
    return bodies;
  }
