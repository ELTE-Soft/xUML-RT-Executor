...
/**
 * Pattern-specific match representation of the hu.eltesoft.modelexecution.uml.incquery.BehaviorParameterLowerBound pattern,
 * to be used in conjunction with {@link BehaviorParameterLowerBoundMatcher}.
 * 
...
public abstract class BehaviorParameterLowerBoundMatch extends BasePatternMatch {
  ...
  private BehaviorParameterLowerBoundMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pLowerBound) {
  ...
  public List<String> parameterNames() {
    return BehaviorParameterLowerBoundMatch.parameterNames;
  ...
  @Override
  public BehaviorParameterLowerBoundMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BehaviorParameterLowerBoundMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    BehaviorParameterLowerBoundMatch other = (BehaviorParameterLowerBoundMatch) obj;
  ...
  @Override
  public BehaviorParameterLowerBoundQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static BehaviorParameterLowerBoundMatch newEmptyMatch() {
   ...
   * 
   */
  public static BehaviorParameterLowerBoundMatch newMutableMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pLowerBound) {
   ...
   * 
   */
  public static BehaviorParameterLowerBoundMatch newMatch(final Behavior pBehavior, final Parameter pParameter, final Type pType, final ValueSpecification pLowerBound) {
    return new Immutable(pBehavior, pParameter, pType, pLowerBound);
    
  }
  
  private static final class Mutable extends BehaviorParameterLowerBoundMatch {
  ...
  private static final class Immutable extends BehaviorParameterLowerBoundMatch {
