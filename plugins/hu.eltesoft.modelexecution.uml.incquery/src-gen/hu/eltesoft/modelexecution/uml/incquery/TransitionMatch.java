...
public abstract class TransitionMatch extends BasePatternMatch {
  ...
  private static List<String> parameterNames = makeImmutableList("region", "source", "transition", "messageName", "target");
  
  private TransitionMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pMessageName, final State pTarget) {
  ...
  public Object[] toArray() {
    return new Object[]{fRegion, fSource, fTransition, fMessageName, fTarget};
    
  }
  
  @Override
  public TransitionMatch toImmutable() {
    return isMutable() ? newMatch(fRegion, fSource, fTransition, fMessageName, fTarget) : this;
   ...
   * 
   */
  public static TransitionMatch newMutableMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pMessageName, final State pTarget) {
    return new Mutable(pRegion, pSource, pTransition, pMessageName, pTarget);
   ...
   * 
   */
  public static TransitionMatch newMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pMessageName, final State pTarget) {
    return new Immutable(pRegion, pSource, pTransition, pMessageName, pTarget);
    
  }
  
  private static final class Mutable extends TransitionMatch {
    Mutable(final Region pRegion, final State pSource, final Transition pTransition, final String pMessageName, final State pTarget) {
      super(pRegion, pSource, pTransition, pMessageName, pTarget);
  ...
  private static final class Immutable extends TransitionMatch {
    Immutable(final Region pRegion, final State pSource, final Transition pTransition, final String pMessageName, final State pTarget) {
      super(pRegion, pSource, pTransition, pMessageName, pTarget);
