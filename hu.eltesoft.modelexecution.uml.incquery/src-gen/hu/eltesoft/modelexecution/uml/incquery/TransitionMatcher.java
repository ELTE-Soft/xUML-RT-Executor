 ...
 * <code><pre>
 * pattern
 * Transition(region : Region, source : State, transition : Transition, transitionName, eventName, target : State) {
...
public class TransitionMatcher extends BaseMatcher<TransitionMatch> {
  ...
  private final static int POSITION_EVENTNAME = 4;
   ...
   * 
   */
  public Collection<TransitionMatch> getAllMatches(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawGetAllMatches(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public TransitionMatch getOneArbitraryMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawGetOneArbitraryMatch(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public boolean hasMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawHasMatch(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public int countMatches(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawCountMatches(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public void forEachMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget, final IMatchProcessor<? super TransitionMatch> processor) {
    rawForEachMatch(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget, final IMatchProcessor<? super TransitionMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget}, processor);
  }
   ...
   */
  @Deprecated
  public DeltaMonitor<TransitionMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public TransitionMatch newMatch(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return TransitionMatch.newMatch(pRegion, pSource, pTransition, pTransitionName, pEventName, pTarget);
   ...
   * 
   */
  public Set<Region> getAllValuesOfregion(final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawAccumulateAllValuesOfregion(new Object[]{null, pSource, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public Set<State> getAllValuesOfsource(final Region pRegion, final Transition pTransition, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawAccumulateAllValuesOfsource(new Object[]{pRegion, null, pTransition, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public Set<Transition> getAllValuesOftransition(final Region pRegion, final State pSource, final String pTransitionName, final String pEventName, final State pTarget) {
    return rawAccumulateAllValuesOftransition(new Object[]{pRegion, pSource, null, pTransitionName, pEventName, pTarget});
  }
   ...
   * 
   */
  public Set<String> getAllValuesOftransitionName(final Region pRegion, final State pSource, final Transition pTransition, final String pEventName, final State pTarget) {
    return rawAccumulateAllValuesOftransitionName(new Object[]{pRegion, pSource, pTransition, null, pEventName, pTarget});
  }
   ...
   * 
   */
  public Set<String> getAllValuesOfeventName(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final State pTarget) {
    return rawAccumulateAllValuesOfeventName(new Object[]{pRegion, pSource, pTransition, pTransitionName, null, pTarget});
  }
   ...
   * 
   */
  public Set<State> getAllValuesOftarget(final Region pRegion, final State pSource, final Transition pTransition, final String pTransitionName, final String pEventName) {
    return rawAccumulateAllValuesOftarget(new Object[]{pRegion, pSource, pTransition, pTransitionName, pEventName, null});
  }
  
  @Override
  protected TransitionMatch tupleToMatch(final Tuple t) {
    try {
      return TransitionMatch.newMatch((org.eclipse.uml2.uml.Region) t.get(POSITION_REGION), (org.eclipse.uml2.uml.State) t.get(POSITION_SOURCE), (org.eclipse.uml2.uml.Transition) t.get(POSITION_TRANSITION), (java.lang.String) t.get(POSITION_TRANSITIONNAME), (java.lang.String) t.get(POSITION_EVENTNAME), (org.eclipse.uml2.uml.State) t.get(POSITION_TARGET));
