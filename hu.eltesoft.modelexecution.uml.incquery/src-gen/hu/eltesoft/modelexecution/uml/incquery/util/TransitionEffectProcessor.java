...
public abstract class TransitionEffectProcessor implements IMatchProcessor<TransitionEffectMatch> {
   ...
   * 
   */
  public abstract void process(final Region pRegion, final Transition pTransition, final String pEffectName);
  
  @Override
  public void process(final TransitionEffectMatch match) {
    process(match.getRegion(), match.getTransition(), match.getEffectName());
