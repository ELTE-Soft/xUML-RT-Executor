 ...
 * </p>
 * <ul>
 *   <li>{@link com.incquerylabs.uml.ralf.reducedAlfLanguage.impl.QualifiedNameListImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QualifiedNameListImpl extends MinimalEObjectImpl.Container implements QualifiedNameList
{
  ...
  {
    return ReducedAlfLanguagePackage.Literals.QUALIFIED_NAME_LIST;
  }
  ...
  public EList<String> getName()
  {
    if (name == null)
    {
      name = new EDataTypeEList<String>(String.class, this, ReducedAlfLanguagePackage.QUALIFIED_NAME_LIST__NAME);
    }
    return name;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ReducedAlfLanguagePackage.QUALIFIED_NAME_LIST__NAME:
        return getName();
    }
