...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.constructorByName pattern,
 * to be used in conjunction with {@link ConstructorByNameMatcher}.
 * 
...
public abstract class ConstructorByNameMatch extends BasePatternMatch {
  ...
  private ConstructorByNameMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
  ...
  public List<String> parameterNames() {
    return ConstructorByNameMatch.parameterNames;
  }
  ...
  @Override
  public ConstructorByNameMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ConstructorByNameMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ConstructorByNameMatch other = (ConstructorByNameMatch) obj;
  ...
  @Override
  public ConstructorByNameQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ConstructorByNameMatch newEmptyMatch() {
   ...
   * 
   */
  public static ConstructorByNameMatch newMutableMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public static ConstructorByNameMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
    return new Immutable(pUmlClass, pOperation);
  }
  
  private static final class Mutable extends ConstructorByNameMatch {
  ...
  private static final class Immutable extends ConstructorByNameMatch {
