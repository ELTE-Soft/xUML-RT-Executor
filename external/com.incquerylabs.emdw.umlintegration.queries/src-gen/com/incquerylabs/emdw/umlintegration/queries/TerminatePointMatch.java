...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.terminatePoint pattern,
 * to be used in conjunction with {@link TerminatePointMatcher}.
 * 
...
public abstract class TerminatePointMatch extends BasePatternMatch {
  private Pseudostate fPseudostate;
  
  private static List<String> parameterNames = makeImmutableList("pseudostate");
  
  private TerminatePointMatch(final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return TerminatePointMatch.parameterNames;
  }
  ...
  @Override
  public TerminatePointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TerminatePointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TerminatePointMatch other = (TerminatePointMatch) obj;
  ...
  @Override
  public TerminatePointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TerminatePointMatch newEmptyMatch() {
   ...
   * 
   */
  public static TerminatePointMatch newMutableMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static TerminatePointMatch newMatch(final Pseudostate pPseudostate) {
    return new Immutable(pPseudostate);
  }
  
  private static final class Mutable extends TerminatePointMatch {
  ...
  private static final class Immutable extends TerminatePointMatch {
