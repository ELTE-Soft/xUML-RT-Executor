...
/**
 * A pattern-specific query specification that can instantiate ToplevelCompositeStateMatcher in a type-safe way.
 * 
...
public final class ToplevelCompositeStateQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelCompositeStateMatcher> {
  ...
  @Override
  protected ToplevelCompositeStateMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelCompositeStateMatcher.on(engine);
  }
  
  @Override
  public ToplevelCompositeStateMatch newEmptyMatch() {
    return ToplevelCompositeStateMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelCompositeStateMatch newMatch(final Object... parameters) {
    return ToplevelCompositeStateMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.State) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelCompositeStateQuerySpecification INSTANCE = make();
    
    public static ToplevelCompositeStateQuerySpecification make() {
      return new ToplevelCompositeStateQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelCompositeStateQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new PositivePatternCall(body, new FlatTuple(var_state, var___1_), RegionQuerySpecification.instance().getInternalQueryRepresentation());
      	bodies.add(body);
      }
