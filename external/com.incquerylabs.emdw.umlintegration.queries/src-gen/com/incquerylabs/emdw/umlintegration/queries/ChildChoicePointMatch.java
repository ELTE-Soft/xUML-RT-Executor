...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childChoicePoint pattern,
 * to be used in conjunction with {@link ChildChoicePointMatcher}.
 * 
...
public abstract class ChildChoicePointMatch extends BasePatternMatch {
  ...
  private ChildChoicePointMatch(final State pState, final Pseudostate pPseudostate) {
    this.fState = pState;
  ...
  public List<String> parameterNames() {
    return ChildChoicePointMatch.parameterNames;
  }
  ...
  @Override
  public ChildChoicePointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildChoicePointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildChoicePointMatch other = (ChildChoicePointMatch) obj;
  ...
  @Override
  public ChildChoicePointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildChoicePointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ChildChoicePointMatch newMutableMatch(final State pState, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ChildChoicePointMatch newMatch(final State pState, final Pseudostate pPseudostate) {
    return new Immutable(pState, pPseudostate);
  }
  
  private static final class Mutable extends ChildChoicePointMatch {
  ...
  private static final class Immutable extends ChildChoicePointMatch {
