...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.entryPoint pattern,
...
public abstract class EntryPointMatch extends BasePatternMatch {
  ...
  private EntryPointMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static EntryPointMatch newMutableMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static EntryPointMatch newMatch(final Pseudostate pPseudostate) {
