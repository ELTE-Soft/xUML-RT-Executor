...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.deepHistory pattern,
 * to be used in conjunction with {@link DeepHistoryMatcher}.
 * 
...
public abstract class DeepHistoryMatch extends BasePatternMatch {
  private Pseudostate fPseudostate;
  
  private static List<String> parameterNames = makeImmutableList("pseudostate");
  
  private DeepHistoryMatch(final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return DeepHistoryMatch.parameterNames;
  }
  ...
  @Override
  public DeepHistoryMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof DeepHistoryMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    DeepHistoryMatch other = (DeepHistoryMatch) obj;
  ...
  @Override
  public DeepHistoryQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static DeepHistoryMatch newEmptyMatch() {
   ...
   * 
   */
  public static DeepHistoryMatch newMutableMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static DeepHistoryMatch newMatch(final Pseudostate pPseudostate) {
    return new Immutable(pPseudostate);
  }
  
  private static final class Mutable extends DeepHistoryMatch {
  ...
  private static final class Immutable extends DeepHistoryMatch {
