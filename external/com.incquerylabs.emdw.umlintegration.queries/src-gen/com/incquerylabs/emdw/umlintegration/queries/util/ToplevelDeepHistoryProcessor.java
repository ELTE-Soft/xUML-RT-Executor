...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.toplevelDeepHistory pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ToplevelDeepHistoryProcessor implements IMatchProcessor<ToplevelDeepHistoryMatch> {
  /**
  ...
  @Override
  public void process(final ToplevelDeepHistoryMatch match) {
