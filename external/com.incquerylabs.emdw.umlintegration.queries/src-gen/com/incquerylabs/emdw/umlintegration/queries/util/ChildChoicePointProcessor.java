...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.childChoicePoint pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ChildChoicePointProcessor implements IMatchProcessor<ChildChoicePointMatch> {
  /**
  ...
  @Override
  public void process(final ChildChoicePointMatch match) {
