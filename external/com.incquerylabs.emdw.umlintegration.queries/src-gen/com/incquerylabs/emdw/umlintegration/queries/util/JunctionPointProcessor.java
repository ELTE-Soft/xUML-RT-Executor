...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.junctionPoint pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class JunctionPointProcessor implements IMatchProcessor<JunctionPointMatch> {
  /**
  ...
  @Override
  public void process(final JunctionPointMatch match) {
