...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childEntryPoint pattern,
 * to be used in conjunction with {@link ChildEntryPointMatcher}.
 * 
...
public abstract class ChildEntryPointMatch extends BasePatternMatch {
  ...
  private ChildEntryPointMatch(final State pState, final Pseudostate pPseudostate) {
    this.fState = pState;
  ...
  public List<String> parameterNames() {
    return ChildEntryPointMatch.parameterNames;
  }
  ...
  @Override
  public ChildEntryPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildEntryPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildEntryPointMatch other = (ChildEntryPointMatch) obj;
  ...
  @Override
  public ChildEntryPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildEntryPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ChildEntryPointMatch newMutableMatch(final State pState, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ChildEntryPointMatch newMatch(final State pState, final Pseudostate pPseudostate) {
    return new Immutable(pState, pPseudostate);
  }
  
  private static final class Mutable extends ChildEntryPointMatch {
  ...
  private static final class Immutable extends ChildEntryPointMatch {
