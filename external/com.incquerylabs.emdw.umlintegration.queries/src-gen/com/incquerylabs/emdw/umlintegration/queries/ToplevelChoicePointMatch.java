...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelChoicePoint pattern,
 * to be used in conjunction with {@link ToplevelChoicePointMatcher}.
 * 
 ...
 * 
 * @see ToplevelChoicePointMatcher
 * @see ToplevelChoicePointProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class ToplevelChoicePointMatch extends BasePatternMatch {
  ...
  private ToplevelChoicePointMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
  ...
  public String patternName() {
    return "com.incquerylabs.emdw.umlintegration.queries.toplevelChoicePoint";
  }
  
  @Override
  public List<String> parameterNames() {
    return ToplevelChoicePointMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelChoicePointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelChoicePointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelChoicePointMatch other = (ToplevelChoicePointMatch) obj;
  ...
  @Override
  public ToplevelChoicePointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelChoicePointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ToplevelChoicePointMatch newMutableMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ToplevelChoicePointMatch newMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
    return new Immutable(pStateMachine, pPseudostate);
  }
  
  private static final class Mutable extends ToplevelChoicePointMatch {
  ...
  private static final class Immutable extends ToplevelChoicePointMatch {
