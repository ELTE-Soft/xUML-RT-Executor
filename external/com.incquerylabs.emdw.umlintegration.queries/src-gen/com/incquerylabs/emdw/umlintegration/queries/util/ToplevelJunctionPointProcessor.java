...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.toplevelJunctionPoint pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class ToplevelJunctionPointProcessor implements IMatchProcessor<ToplevelJunctionPointMatch> {
  /**
  ...
  @Override
  public void process(final ToplevelJunctionPointMatch match) {
