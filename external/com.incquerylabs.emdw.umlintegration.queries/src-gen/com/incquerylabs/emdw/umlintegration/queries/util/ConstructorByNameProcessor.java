...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.constructorByName pattern.
 * 
...
public abstract class ConstructorByNameProcessor implements IMatchProcessor<ConstructorByNameMatch> {
  ...
  @Override
  public void process(final ConstructorByNameMatch match) {
