...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.xtSignalEvent pattern,
 * to be used in conjunction with {@link XtSignalEventMatcher}.
 * 
...
public abstract class XtSignalEventMatch extends BasePatternMatch {
  ...
  private XtSignalEventMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Signal pSignal) {
  ...
  public List<String> parameterNames() {
    return XtSignalEventMatch.parameterNames;
  }
  ...
  @Override
  public XtSignalEventMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof XtSignalEventMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    XtSignalEventMatch other = (XtSignalEventMatch) obj;
  ...
  @Override
  public XtSignalEventQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static XtSignalEventMatch newEmptyMatch() {
   ...
   * 
   */
  public static XtSignalEventMatch newMutableMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Signal pSignal) {
   ...
   * 
   */
  public static XtSignalEventMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Signal pSignal) {
    return new Immutable(pUmlClass, pSignal);
  }
  
  private static final class Mutable extends XtSignalEventMatch {
  ...
  private static final class Immutable extends XtSignalEventMatch {
