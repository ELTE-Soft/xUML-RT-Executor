...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childInitialPoint pattern,
 * to be used in conjunction with {@link ChildInitialPointMatcher}.
 * 
...
public abstract class ChildInitialPointMatch extends BasePatternMatch {
  ...
  private ChildInitialPointMatch(final State pState, final Pseudostate pPseudostate) {
    this.fState = pState;
  ...
  public List<String> parameterNames() {
    return ChildInitialPointMatch.parameterNames;
  }
  ...
  @Override
  public ChildInitialPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildInitialPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildInitialPointMatch other = (ChildInitialPointMatch) obj;
  ...
  @Override
  public ChildInitialPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildInitialPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ChildInitialPointMatch newMutableMatch(final State pState, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ChildInitialPointMatch newMatch(final State pState, final Pseudostate pPseudostate) {
    return new Immutable(pState, pPseudostate);
  }
  
  private static final class Mutable extends ChildInitialPointMatch {
  ...
  private static final class Immutable extends ChildInitialPointMatch {
