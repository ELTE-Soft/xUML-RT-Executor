...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childJunctionPoint pattern,
 * to be used in conjunction with {@link ChildJunctionPointMatcher}.
 * 
...
public abstract class ChildJunctionPointMatch extends BasePatternMatch {
  ...
  private ChildJunctionPointMatch(final State pState, final Pseudostate pPseudostate) {
    this.fState = pState;
  ...
  public List<String> parameterNames() {
    return ChildJunctionPointMatch.parameterNames;
  }
  ...
  @Override
  public ChildJunctionPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildJunctionPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildJunctionPointMatch other = (ChildJunctionPointMatch) obj;
  ...
  @Override
  public ChildJunctionPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildJunctionPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ChildJunctionPointMatch newMutableMatch(final State pState, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ChildJunctionPointMatch newMatch(final State pState, final Pseudostate pPseudostate) {
    return new Immutable(pState, pPseudostate);
  }
  
  private static final class Mutable extends ChildJunctionPointMatch {
  ...
  private static final class Immutable extends ChildJunctionPointMatch {
