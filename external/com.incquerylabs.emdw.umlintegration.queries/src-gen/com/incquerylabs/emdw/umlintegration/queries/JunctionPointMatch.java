...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.junctionPoint pattern,
 * to be used in conjunction with {@link JunctionPointMatcher}.
 * 
...
public abstract class JunctionPointMatch extends BasePatternMatch {
  private Pseudostate fPseudostate;
  
  private static List<String> parameterNames = makeImmutableList("pseudostate");
  
  private JunctionPointMatch(final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return JunctionPointMatch.parameterNames;
  }
  ...
  @Override
  public JunctionPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof JunctionPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    JunctionPointMatch other = (JunctionPointMatch) obj;
  ...
  @Override
  public JunctionPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static JunctionPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static JunctionPointMatch newMutableMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static JunctionPointMatch newMatch(final Pseudostate pPseudostate) {
    return new Immutable(pPseudostate);
  }
  
  private static final class Mutable extends JunctionPointMatch {
  ...
  private static final class Immutable extends JunctionPointMatch {
