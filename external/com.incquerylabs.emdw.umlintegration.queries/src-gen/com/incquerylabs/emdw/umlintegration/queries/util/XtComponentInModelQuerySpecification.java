...
/**
 * A pattern-specific query specification that can instantiate XtComponentInModelMatcher in a type-safe way.
 * 
...
public final class XtComponentInModelQuerySpecification extends BaseGeneratedEMFQuerySpecification<XtComponentInModelMatcher> {
  private XtComponentInModelQuerySpecification() {
   ...
   * 
   */
  public static XtComponentInModelQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected XtComponentInModelMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return XtComponentInModelMatcher.on(engine);
  }
  
  @Override
  public XtComponentInModelMatch newEmptyMatch() {
    return XtComponentInModelMatch.newEmptyMatch();
  }
  
  @Override
  public XtComponentInModelMatch newMatch(final Object... parameters) {
    return XtComponentInModelMatch.newMatch((org.eclipse.uml2.uml.Model) parameters[0], (org.eclipse.uml2.uml.Component) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static XtComponentInModelQuerySpecification INSTANCE = make();
    
    public static XtComponentInModelQuerySpecification make() {
      return new XtComponentInModelQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static XtComponentInModelQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public List<String> getParameterNames() {
      return Arrays.asList("model","component");
    }
    
    @Override
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("model", "org.eclipse.uml2.uml.Model"),new PParameter("component", "org.eclipse.uml2.uml.Component"));
    }
