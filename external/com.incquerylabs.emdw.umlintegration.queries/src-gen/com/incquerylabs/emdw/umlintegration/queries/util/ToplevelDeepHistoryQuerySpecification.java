...
/**
 * A pattern-specific query specification that can instantiate ToplevelDeepHistoryMatcher in a type-safe way.
 * 
 * @see ToplevelDeepHistoryMatcher
 * @see ToplevelDeepHistoryMatch
 * 
 */
@SuppressWarnings("all")
public final class ToplevelDeepHistoryQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelDeepHistoryMatcher> {
  private ToplevelDeepHistoryQuerySpecification() {
   ...
   * 
   */
  public static ToplevelDeepHistoryQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ToplevelDeepHistoryMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelDeepHistoryMatcher.on(engine);
  }
  
  @Override
  public ToplevelDeepHistoryMatch newEmptyMatch() {
    return ToplevelDeepHistoryMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelDeepHistoryMatch newMatch(final Object... parameters) {
    return ToplevelDeepHistoryMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelDeepHistoryQuerySpecification INSTANCE = make();
    
    public static ToplevelDeepHistoryQuerySpecification make() {
      return new ToplevelDeepHistoryQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelDeepHistoryQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.incquerylabs.emdw.umlintegration.queries.toplevelDeepHistory";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new ConstantValue(body, var__virtual_1_, org.eclipse.uml2.uml.PseudostateKind.get("deepHistory"));
