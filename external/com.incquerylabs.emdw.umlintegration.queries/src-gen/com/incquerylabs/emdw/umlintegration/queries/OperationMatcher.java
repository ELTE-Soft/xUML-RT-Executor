...
/**
 * Generated pattern matcher API of the com.incquerylabs.emdw.umlintegration.queries.operation pattern,
...
public class OperationMatcher extends BaseMatcher<OperationMatch> {
   ...
   * 
   */
  public Collection<OperationMatch> getAllMatches(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public OperationMatch getOneArbitraryMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public void forEachMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation, final IMatchProcessor<? super OperationMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation, final IMatchProcessor<? super OperationMatch> processor) {
   ...
   * 
   */
  public OperationMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
    return OperationMatch.newMatch(pUmlClass, pOperation);
  }
   ...
   * 
   */
  public Set<org.eclipse.uml2.uml.Class> getAllValuesOfumlClass(final OperationMatch partialMatch) {
  ...
  protected OperationMatch tupleToMatch(final Tuple t) {
    try {
    	return OperationMatch.newMatch((org.eclipse.uml2.uml.Class) t.get(POSITION_UMLCLASS), (org.eclipse.uml2.uml.Operation) t.get(POSITION_OPERATION));
  ...
  protected OperationMatch arrayToMatch(final Object[] match) {
    try {
    	return OperationMatch.newMatch((org.eclipse.uml2.uml.Class) match[POSITION_UMLCLASS], (org.eclipse.uml2.uml.Operation) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
  ...
  protected OperationMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return OperationMatch.newMutableMatch((org.eclipse.uml2.uml.Class) match[POSITION_UMLCLASS], (org.eclipse.uml2.uml.Operation) match[POSITION_OPERATION]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
