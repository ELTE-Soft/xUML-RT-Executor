...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.constructorOperation pattern,
 * to be used in conjunction with {@link ConstructorOperationMatcher}.
 * 
 ...
 * @see ConstructorOperationProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class ConstructorOperationMatch extends BasePatternMatch {
  ...
  private ConstructorOperationMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
  ...
  public List<String> parameterNames() {
    return ConstructorOperationMatch.parameterNames;
  }
  ...
  @Override
  public ConstructorOperationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ConstructorOperationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ConstructorOperationMatch other = (ConstructorOperationMatch) obj;
  ...
  @Override
  public ConstructorOperationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ConstructorOperationMatch newEmptyMatch() {
   ...
   * 
   */
  public static ConstructorOperationMatch newMutableMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public static ConstructorOperationMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
    return new Immutable(pUmlClass, pOperation);
  }
  
  private static final class Mutable extends ConstructorOperationMatch {
  ...
  private static final class Immutable extends ConstructorOperationMatch {
