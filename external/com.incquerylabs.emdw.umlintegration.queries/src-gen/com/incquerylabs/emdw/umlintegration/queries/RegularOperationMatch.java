...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.regularOperation pattern,
 * to be used in conjunction with {@link RegularOperationMatcher}.
 * 
...
public abstract class RegularOperationMatch extends BasePatternMatch {
  ...
  private RegularOperationMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
  ...
  public List<String> parameterNames() {
    return RegularOperationMatch.parameterNames;
  }
  ...
  @Override
  public RegularOperationMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RegularOperationMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    RegularOperationMatch other = (RegularOperationMatch) obj;
  ...
  @Override
  public RegularOperationQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static RegularOperationMatch newEmptyMatch() {
   ...
   * 
   */
  public static RegularOperationMatch newMutableMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public static RegularOperationMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
    return new Immutable(pUmlClass, pOperation);
  }
  
  private static final class Mutable extends RegularOperationMatch {
  ...
  private static final class Immutable extends RegularOperationMatch {
