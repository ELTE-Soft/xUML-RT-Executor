...
/**
 * A pattern-specific query specification that can instantiate ToplevelChoicePointMatcher in a type-safe way.
 * 
...
public final class ToplevelChoicePointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelChoicePointMatcher> {
  private ToplevelChoicePointQuerySpecification() {
   ...
   * 
   */
  public static ToplevelChoicePointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ToplevelChoicePointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelChoicePointMatcher.on(engine);
  }
  
  @Override
  public ToplevelChoicePointMatch newEmptyMatch() {
    return ToplevelChoicePointMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelChoicePointMatch newMatch(final Object... parameters) {
    return ToplevelChoicePointMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelChoicePointQuerySpecification INSTANCE = make();
    
    public static ToplevelChoicePointQuerySpecification make() {
      return new ToplevelChoicePointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelChoicePointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
