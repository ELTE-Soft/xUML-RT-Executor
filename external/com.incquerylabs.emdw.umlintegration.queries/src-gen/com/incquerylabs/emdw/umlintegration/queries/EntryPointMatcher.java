...
/**
 * Generated pattern matcher API of the com.incquerylabs.emdw.umlintegration.queries.entryPoint pattern,
...
public class EntryPointMatcher extends BaseMatcher<EntryPointMatch> {
   ...
   * 
   */
  public Collection<EntryPointMatch> getAllMatches(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public EntryPointMatch getOneArbitraryMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public void forEachMatch(final Pseudostate pPseudostate, final IMatchProcessor<? super EntryPointMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Pseudostate pPseudostate, final IMatchProcessor<? super EntryPointMatch> processor) {
   ...
   * 
   */
  public EntryPointMatch newMatch(final Pseudostate pPseudostate) {
    return EntryPointMatch.newMatch(pPseudostate);
  }
  ...
  protected EntryPointMatch tupleToMatch(final Tuple t) {
    try {
    	return EntryPointMatch.newMatch((org.eclipse.uml2.uml.Pseudostate) t.get(POSITION_PSEUDOSTATE));
  ...
  protected EntryPointMatch arrayToMatch(final Object[] match) {
    try {
    	return EntryPointMatch.newMatch((org.eclipse.uml2.uml.Pseudostate) match[POSITION_PSEUDOSTATE]);
    } catch(ClassCastException e) {
  ...
  protected EntryPointMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EntryPointMatch.newMutableMatch((org.eclipse.uml2.uml.Pseudostate) match[POSITION_PSEUDOSTATE]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
