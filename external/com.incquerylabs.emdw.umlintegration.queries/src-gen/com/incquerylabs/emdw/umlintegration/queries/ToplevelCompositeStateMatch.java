...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelCompositeState pattern,
 * to be used in conjunction with {@link ToplevelCompositeStateMatcher}.
 * 
 ...
 * 
 * @see ToplevelCompositeStateMatcher
 * @see ToplevelCompositeStateProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class ToplevelCompositeStateMatch extends BasePatternMatch {
  ...
  private ToplevelCompositeStateMatch(final StateMachine pStateMachine, final State pState) {
  ...
  public List<String> parameterNames() {
    return ToplevelCompositeStateMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelCompositeStateMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelCompositeStateMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelCompositeStateMatch other = (ToplevelCompositeStateMatch) obj;
  ...
  @Override
  public ToplevelCompositeStateQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelCompositeStateMatch newEmptyMatch() {
   ...
   * 
   */
  public static ToplevelCompositeStateMatch newMutableMatch(final StateMachine pStateMachine, final State pState) {
   ...
   * 
   */
  public static ToplevelCompositeStateMatch newMatch(final StateMachine pStateMachine, final State pState) {
    return new Immutable(pStateMachine, pState);
  }
  
  private static final class Mutable extends ToplevelCompositeStateMatch {
  ...
  private static final class Immutable extends ToplevelCompositeStateMatch {
