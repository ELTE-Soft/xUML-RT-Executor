...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelEntryPoint pattern,
 * to be used in conjunction with {@link ToplevelEntryPointMatcher}.
 * 
...
public abstract class ToplevelEntryPointMatch extends BasePatternMatch {
  ...
  private ToplevelEntryPointMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return ToplevelEntryPointMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelEntryPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelEntryPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelEntryPointMatch other = (ToplevelEntryPointMatch) obj;
  ...
  @Override
  public ToplevelEntryPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelEntryPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ToplevelEntryPointMatch newMutableMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ToplevelEntryPointMatch newMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
    return new Immutable(pStateMachine, pPseudostate);
  }
  
  private static final class Mutable extends ToplevelEntryPointMatch {
  ...
  private static final class Immutable extends ToplevelEntryPointMatch {
