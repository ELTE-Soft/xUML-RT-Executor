...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelDeepHistory pattern,
 * to be used in conjunction with {@link ToplevelDeepHistoryMatcher}.
 * 
...
public abstract class ToplevelDeepHistoryMatch extends BasePatternMatch {
  ...
  private ToplevelDeepHistoryMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return ToplevelDeepHistoryMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelDeepHistoryMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelDeepHistoryMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelDeepHistoryMatch other = (ToplevelDeepHistoryMatch) obj;
  ...
  @Override
  public ToplevelDeepHistoryQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelDeepHistoryMatch newEmptyMatch() {
   ...
   * 
   */
  public static ToplevelDeepHistoryMatch newMutableMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ToplevelDeepHistoryMatch newMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
    return new Immutable(pStateMachine, pPseudostate);
  }
  
  private static final class Mutable extends ToplevelDeepHistoryMatch {
  ...
  private static final class Immutable extends ToplevelDeepHistoryMatch {
