...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelExitPoint pattern,
 * to be used in conjunction with {@link ToplevelExitPointMatcher}.
 * 
 ...
 * 
 * @see ToplevelExitPointMatcher
 * @see ToplevelExitPointProcessor
 * 
 */
@SuppressWarnings("all")
public abstract class ToplevelExitPointMatch extends BasePatternMatch {
  ...
  private ToplevelExitPointMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
  ...
  public String patternName() {
    return "com.incquerylabs.emdw.umlintegration.queries.toplevelExitPoint";
  }
  
  @Override
  public List<String> parameterNames() {
    return ToplevelExitPointMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelExitPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelExitPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelExitPointMatch other = (ToplevelExitPointMatch) obj;
  ...
  @Override
  public ToplevelExitPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelExitPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static ToplevelExitPointMatch newMutableMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ToplevelExitPointMatch newMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
    return new Immutable(pStateMachine, pPseudostate);
  }
  
  private static final class Mutable extends ToplevelExitPointMatch {
  ...
  private static final class Immutable extends ToplevelExitPointMatch {
