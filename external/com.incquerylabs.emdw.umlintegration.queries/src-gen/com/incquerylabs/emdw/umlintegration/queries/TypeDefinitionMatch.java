...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.typeDefinition pattern,
 * to be used in conjunction with {@link TypeDefinitionMatcher}.
 * 
...
public abstract class TypeDefinitionMatch extends BasePatternMatch {
  ...
  private TypeDefinitionMatch(final Type pType) {
    this.fType = pType;
  }
  ...
  public List<String> parameterNames() {
    return TypeDefinitionMatch.parameterNames;
  }
  ...
  @Override
  public TypeDefinitionMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TypeDefinitionMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    TypeDefinitionMatch other = (TypeDefinitionMatch) obj;
  ...
  @Override
  public TypeDefinitionQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TypeDefinitionMatch newMutableMatch(final Type pType) {
   ...
   * 
   */
  public static TypeDefinitionMatch newMatch(final Type pType) {
    return new Immutable(pType);
  }
  
  private static final class Mutable extends TypeDefinitionMatch {
  ...
  private static final class Immutable extends TypeDefinitionMatch {
