...
/**
 * A pattern-specific query specification that can instantiate ToplevelJunctionPointMatcher in a type-safe way.
 * 
...
public final class ToplevelJunctionPointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelJunctionPointMatcher> {
  private ToplevelJunctionPointQuerySpecification() {
   ...
   * 
   */
  public static ToplevelJunctionPointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ToplevelJunctionPointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelJunctionPointMatcher.on(engine);
  }
  
  @Override
  public ToplevelJunctionPointMatch newEmptyMatch() {
    return ToplevelJunctionPointMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelJunctionPointMatch newMatch(final Object... parameters) {
    return ToplevelJunctionPointMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelJunctionPointQuerySpecification INSTANCE = make();
    
    public static ToplevelJunctionPointQuerySpecification make() {
      return new ToplevelJunctionPointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelJunctionPointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
