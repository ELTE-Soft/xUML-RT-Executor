...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.operation pattern,
...
public abstract class OperationMatch extends BasePatternMatch {
  ...
  private OperationMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public static OperationMatch newMutableMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
   ...
   * 
   */
  public static OperationMatch newMatch(final org.eclipse.uml2.uml.Class pUmlClass, final Operation pOperation) {
