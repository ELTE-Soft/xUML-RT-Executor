...
/**
 * A pattern-specific query specification that can instantiate ChildJunctionPointMatcher in a type-safe way.
 * 
 * @see ChildJunctionPointMatcher
 * @see ChildJunctionPointMatch
 * 
 */
@SuppressWarnings("all")
public final class ChildJunctionPointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ChildJunctionPointMatcher> {
  private ChildJunctionPointQuerySpecification() {
   ...
   * 
   */
  public static ChildJunctionPointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ChildJunctionPointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ChildJunctionPointMatcher.on(engine);
  }
  
  @Override
  public ChildJunctionPointMatch newEmptyMatch() {
    return ChildJunctionPointMatch.newEmptyMatch();
  }
  
  @Override
  public ChildJunctionPointMatch newMatch(final Object... parameters) {
    return ChildJunctionPointMatch.newMatch((org.eclipse.uml2.uml.State) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ChildJunctionPointQuerySpecification INSTANCE = make();
    
    public static ChildJunctionPointQuerySpecification make() {
      return new ChildJunctionPointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ChildJunctionPointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.incquerylabs.emdw.umlintegration.queries.childJunctionPoint";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new ConstantValue(body, var__virtual_1_, org.eclipse.uml2.uml.PseudostateKind.get("junction"));
