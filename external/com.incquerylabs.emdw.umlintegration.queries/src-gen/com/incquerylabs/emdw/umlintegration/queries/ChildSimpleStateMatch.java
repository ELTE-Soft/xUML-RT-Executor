...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childSimpleState pattern,
 * to be used in conjunction with {@link ChildSimpleStateMatcher}.
 * 
...
public abstract class ChildSimpleStateMatch extends BasePatternMatch {
  ...
  private ChildSimpleStateMatch(final State pParentState, final State pState) {
  ...
  public List<String> parameterNames() {
    return ChildSimpleStateMatch.parameterNames;
  }
  ...
  @Override
  public ChildSimpleStateMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildSimpleStateMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildSimpleStateMatch other = (ChildSimpleStateMatch) obj;
  ...
  @Override
  public ChildSimpleStateQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildSimpleStateMatch newEmptyMatch() {
   ...
   * 
   */
  public static ChildSimpleStateMatch newMutableMatch(final State pParentState, final State pState) {
   ...
   * 
   */
  public static ChildSimpleStateMatch newMatch(final State pParentState, final State pState) {
    return new Immutable(pParentState, pState);
  }
  
  private static final class Mutable extends ChildSimpleStateMatch {
  ...
  private static final class Immutable extends ChildSimpleStateMatch {
