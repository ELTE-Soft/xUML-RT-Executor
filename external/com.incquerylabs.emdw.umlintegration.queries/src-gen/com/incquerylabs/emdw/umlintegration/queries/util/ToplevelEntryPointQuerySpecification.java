...
/**
 * A pattern-specific query specification that can instantiate ToplevelEntryPointMatcher in a type-safe way.
 * 
 * @see ToplevelEntryPointMatcher
 * @see ToplevelEntryPointMatch
 * 
 */
@SuppressWarnings("all")
public final class ToplevelEntryPointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelEntryPointMatcher> {
  private ToplevelEntryPointQuerySpecification() {
   ...
   * 
   */
  public static ToplevelEntryPointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ToplevelEntryPointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelEntryPointMatcher.on(engine);
  }
  
  @Override
  public ToplevelEntryPointMatch newEmptyMatch() {
    return ToplevelEntryPointMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelEntryPointMatch newMatch(final Object... parameters) {
    return ToplevelEntryPointMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelEntryPointQuerySpecification INSTANCE = make();
    
    public static ToplevelEntryPointQuerySpecification make() {
      return new ToplevelEntryPointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelEntryPointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.incquerylabs.emdw.umlintegration.queries.toplevelEntryPoint";
    }
    ...
    public Set<PBody> doGetContainedBodies() throws QueryInitializationException {
      ...
      try {
      {
      	...
      	new ConstantValue(body, var__virtual_1_, org.eclipse.uml2.uml.PseudostateKind.get("entryPoint"));
