...
/**
 * A pattern-specific query specification that can instantiate ChildEntryPointMatcher in a type-safe way.
 * 
 * @see ChildEntryPointMatcher
 * @see ChildEntryPointMatch
 * 
 */
@SuppressWarnings("all")
public final class ChildEntryPointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ChildEntryPointMatcher> {
  private ChildEntryPointQuerySpecification() {
   ...
   * 
   */
  public static ChildEntryPointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ChildEntryPointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ChildEntryPointMatcher.on(engine);
  }
  
  @Override
  public ChildEntryPointMatch newEmptyMatch() {
    return ChildEntryPointMatch.newEmptyMatch();
  }
  
  @Override
  public ChildEntryPointMatch newMatch(final Object... parameters) {
    return ChildEntryPointMatch.newMatch((org.eclipse.uml2.uml.State) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ChildEntryPointQuerySpecification INSTANCE = make();
    
    public static ChildEntryPointQuerySpecification make() {
      return new ChildEntryPointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ChildEntryPointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    
    @Override
    public String getFullyQualifiedName() {
      return "com.incquerylabs.emdw.umlintegration.queries.childEntryPoint";
    }
