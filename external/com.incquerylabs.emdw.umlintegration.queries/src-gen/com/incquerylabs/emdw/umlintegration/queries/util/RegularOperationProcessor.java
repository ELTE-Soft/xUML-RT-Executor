...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.regularOperation pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class RegularOperationProcessor implements IMatchProcessor<RegularOperationMatch> {
  /**
  ...
  @Override
  public void process(final RegularOperationMatch match) {
