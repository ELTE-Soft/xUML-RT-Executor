...
/**
 * A pattern-specific query specification that can instantiate ChildDeepHistoryMatcher in a type-safe way.
 * 
...
public final class ChildDeepHistoryQuerySpecification extends BaseGeneratedEMFQuerySpecification<ChildDeepHistoryMatcher> {
  private ChildDeepHistoryQuerySpecification() {
   ...
   * 
   */
  public static ChildDeepHistoryQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ChildDeepHistoryMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ChildDeepHistoryMatcher.on(engine);
  }
  
  @Override
  public ChildDeepHistoryMatch newEmptyMatch() {
    return ChildDeepHistoryMatch.newEmptyMatch();
  }
  
  @Override
  public ChildDeepHistoryMatch newMatch(final Object... parameters) {
    return ChildDeepHistoryMatch.newMatch((org.eclipse.uml2.uml.State) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ChildDeepHistoryQuerySpecification INSTANCE = make();
    
    public static ChildDeepHistoryQuerySpecification make() {
      return new ChildDeepHistoryQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ChildDeepHistoryQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
