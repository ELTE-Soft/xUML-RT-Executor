...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.initialPoint pattern,
 * to be used in conjunction with {@link InitialPointMatcher}.
 * 
...
public abstract class InitialPointMatch extends BasePatternMatch {
  private Pseudostate fPseudostate;
  
  private static List<String> parameterNames = makeImmutableList("pseudostate");
  
  private InitialPointMatch(final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return InitialPointMatch.parameterNames;
  }
  ...
  @Override
  public InitialPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof InitialPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    InitialPointMatch other = (InitialPointMatch) obj;
  ...
  @Override
  public InitialPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static InitialPointMatch newEmptyMatch() {
   ...
   * 
   */
  public static InitialPointMatch newMutableMatch(final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static InitialPointMatch newMatch(final Pseudostate pPseudostate) {
    return new Immutable(pPseudostate);
  }
  
  private static final class Mutable extends InitialPointMatch {
  ...
  private static final class Immutable extends InitialPointMatch {
