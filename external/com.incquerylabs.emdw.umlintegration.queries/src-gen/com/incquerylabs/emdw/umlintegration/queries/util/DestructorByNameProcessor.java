...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.destructorByName pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class DestructorByNameProcessor implements IMatchProcessor<DestructorByNameMatch> {
  /**
  ...
  @Override
  public void process(final DestructorByNameMatch match) {
