...
/**
 * A match processor tailored for the com.incquerylabs.emdw.umlintegration.queries.childTerminatePoint pattern.
 * 
...
public abstract class ChildTerminatePointProcessor implements IMatchProcessor<ChildTerminatePointMatch> {
  ...
  @Override
  public void process(final ChildTerminatePointMatch match) {
