...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.childExitPoint pattern,
 * to be used in conjunction with {@link ChildExitPointMatcher}.
 * 
...
public abstract class ChildExitPointMatch extends BasePatternMatch {
  ...
  private ChildExitPointMatch(final State pState, final Pseudostate pPseudostate) {
    this.fState = pState;
  ...
  public List<String> parameterNames() {
    return ChildExitPointMatch.parameterNames;
  }
  ...
  @Override
  public ChildExitPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildExitPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ChildExitPointMatch other = (ChildExitPointMatch) obj;
  ...
  @Override
  public ChildExitPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ChildExitPointMatch newMutableMatch(final State pState, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ChildExitPointMatch newMatch(final State pState, final Pseudostate pPseudostate) {
    return new Immutable(pState, pPseudostate);
  }
  
  private static final class Mutable extends ChildExitPointMatch {
  ...
  private static final class Immutable extends ChildExitPointMatch {
