...
/**
 * A pattern-specific query specification that can instantiate ToplevelExitPointMatcher in a type-safe way.
 * 
...
public final class ToplevelExitPointQuerySpecification extends BaseGeneratedEMFQuerySpecification<ToplevelExitPointMatcher> {
  private ToplevelExitPointQuerySpecification() {
   ...
   * 
   */
  public static ToplevelExitPointQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected ToplevelExitPointMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
    return ToplevelExitPointMatcher.on(engine);
  }
  
  @Override
  public ToplevelExitPointMatch newEmptyMatch() {
    return ToplevelExitPointMatch.newEmptyMatch();
  }
  
  @Override
  public ToplevelExitPointMatch newMatch(final Object... parameters) {
    return ToplevelExitPointMatch.newMatch((org.eclipse.uml2.uml.StateMachine) parameters[0], (org.eclipse.uml2.uml.Pseudostate) parameters[1]);
  }
  
  private static class LazyHolder {
    private final static ToplevelExitPointQuerySpecification INSTANCE = make();
    
    public static ToplevelExitPointQuerySpecification make() {
      return new ToplevelExitPointQuerySpecification();					
    }
  }
  
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private final static ToplevelExitPointQuerySpecification.GeneratedPQuery INSTANCE = new GeneratedPQuery();
