...
/**
 * Pattern-specific match representation of the com.incquerylabs.emdw.umlintegration.queries.toplevelInitialPoint pattern,
 * to be used in conjunction with {@link ToplevelInitialPointMatcher}.
 * 
...
public abstract class ToplevelInitialPointMatch extends BasePatternMatch {
  ...
  private ToplevelInitialPointMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
  ...
  public List<String> parameterNames() {
    return ToplevelInitialPointMatch.parameterNames;
  }
  ...
  @Override
  public ToplevelInitialPointMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ToplevelInitialPointMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ToplevelInitialPointMatch other = (ToplevelInitialPointMatch) obj;
  ...
  @Override
  public ToplevelInitialPointQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ToplevelInitialPointMatch newMutableMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
   ...
   * 
   */
  public static ToplevelInitialPointMatch newMatch(final StateMachine pStateMachine, final Pseudostate pPseudostate) {
    return new Immutable(pStateMachine, pPseudostate);
  }
  
  private static final class Mutable extends ToplevelInitialPointMatch {
  ...
  private static final class Immutable extends ToplevelInitialPointMatch {
